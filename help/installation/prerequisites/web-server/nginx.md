...
Adobe Commerce prend en charge la version 1.18 (ou la version [dernière version de mainline](https://nginx.org/en/linux_packages.html#mainline)). Vous devez également installer la dernière version de `php-fpm`.
