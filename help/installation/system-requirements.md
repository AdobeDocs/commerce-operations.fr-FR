...
Le modèle [Commerce on Cloud](https://github.com/magento/magento-cloud) fournit une configuration par défaut pour les services compatibles avec la dernière version de Commerce pour chaque ligne de version.
