...
1. Connectez-vous à [Cloud Console](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/start/cloud-console). Tous vos environnements s’affichent dans la console Cloud.
