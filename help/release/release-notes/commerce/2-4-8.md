...
<table style="table-layout:auto">
    <tbody>
        ...
        <td>
            <ul>
                <li><!--LYNX-387-->Ajout des nouveaux champs suivants au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartitemprices"><code>CartItemPrices</code></a> pour prendre en charge l’affichage précis des prix et les calculs de remise :
                <ul>
              ...
              <li><!--LYNX-451-->Ajout du champ <code>grand_total_excluding_tax</code> au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartprices"><code>CartPrices</code></a>, fournissant une tarification taxe incluse claire.</li>
              <li><!--LYNX-377-->Ajout de la <code>not_available_message</code> à la <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/cart/interfaces/"><code>CartItemInterface</code></a> .</li>
            </ul>
        </td>
       </tr>
        <tr>
        ...
        <tr>
           ...
           <td>Cette version comprend les améliorations suivantes apportées à la gestion des commandes des utilisateurs :
             <ul>
              ...
              <li><!--LYNX-470-->Ajout d’un nouveau champ <code>date_of_first_order</code> au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorders"><code>CustomerOrders</code></a>.</li>
              <li><!--LYNX-468-->Extension du type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#orderaddress"><code>OrderAddress</code></a> pour inclure des attributs personnalisés, ce qui améliore la visibilité des détails des commandes. Prend en charge l’affichage d’informations supplémentaires sur les pages de confirmation de commande.</li>
              <li><!--LYNX-450-->Ajout du champ <code>is_virtual</code> au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>, prenant en charge l’identification de produit virtuel. Améliore le traitement des commandes en distinguant les produits virtuels des produits physiques.</li>
              <li><!--LYNX-449-->Ajout d’un type de <code>OrderItemPrices</code> similaire à <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartitemprices"><code>CartItemPrices</code></a> à <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#orderiteminterface"><code>OrderItemInterface</code></a> avec plusieurs nouveaux champs pour le prix.</li>
              ...
              <li><!-- LYNX-523: -->Extension du type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a> pour inclure un champ <code>available_actions</code> pour une meilleure gestion des commandes. Le champ « available_actions » est mappé à une énumération qui répertorie les actions possibles qui peuvent être effectuées sur la commande.</li>
              <li><!-- LYNX-524 -->Ajout du champ <code>customer_info</code> au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>. Ce champ nécessite le type de <code>OrderCustomerInfo</code> , qui contient des détails sur le nom du client.</li>
              ...
              <li><!--LYNX-470-->Ajout d’un filtre d’historique des commandes basé sur le champ <code>created_at</code> et <code>date_of_first_order</code> exposées avec le type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorders"><code>CustomerOrders</code></a> .</li>
              <li><!--LYNX-450-->Ajout du champ <code>is_virtual</code> au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>, similaire au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cart"><code>Cart</code></a>. Cela permet au client de masquer de manière conditionnelle les informations d’expédition pour les commandes contenant uniquement des produits virtuels.</li>
        ...
        <td>
            <ul>
              <li><!--LYNX-540-->Ajout d’un champ de <code>quantity</code> dans le <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#productinterface"><code>ProductInterface</code></a> pour fournir des détails sur le niveau de stock. Il affiche le stock disponible ou la valeur null en fonction des paramètres d’administration.</li>
              ...
              <li><!--LYNX-401-->Ajout des champs <code>grouped_product_image</code> et <code>configurable_product_image</code> au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#storeconfig"><code>StoreConfig</code></a>.</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
              <li><!--LYNX-713-->Mise à jour des types <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-f-i#giftoptionsprices"><code>GiftOptionsPrices</code></a> et <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#ordertotal"><code>OrderTotal</code></a> pour inclure les champs <code>price_excluding_tax</code> et <code>price_including_tax</code> pour l’emballage-cadeau (par article et commande) et les cartes imprimées. Cette amélioration garantit un affichage précis des taxes en fonction des paramètres de configuration du magasin pour les requêtes de panier et de commande.</li>
              ...
              <li><!--LYNX-693-->Ajout de champs <code>gift_message</code> et <code>gift_wrapping</code> au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-f-i#giftcarditem"><code>GiftCardCartItem</code></a>. Mise à jour de la logique pour ignorer l’emballage cadeau pour les produits virtuels.</li>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-632-->Mise à jour de la mutation <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/mutations#requestreturn"><code>requestReturn</code></a> pour l'entrée d'éléments RMA pour résoudre les incohérences entre la requête liée à l'attribut de retour et la mutation.</li>
                <li><!--LYNX-515-->Mise à jour de la mutation <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/mutations#requestreturn"><code>requestReturn</code></a> pour prendre en charge les retours de commande des invités.</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-633-->Mise à jour du type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#storeconfig"><code>StoreConfig</code></a> avec des champs pour correspondre aux paramètres d’affichage des taxes dans la configuration Admin.</li>
                <li><!--LYNX-697-->Ajout des champs <code>subtotal_excl_tax</code> et <code>subtotal_incl_tax</code> au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#ordertotal"><code>OrderTotal</code></a>. Le champ <code>subtotal</code> a été marqué comme obsolète.</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-618-->Ajout d’un identifiant pour le carnet d’adresses dans l’adresse du panier d’expédition ou de facturation dans le type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartaddressinterface"><code>CartAddressInterface</code></a>.</li>
                <li><!--LYNX-617-->Ajout du champ <code>same_as_billing</code> au type de <a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#shippingcartaddress"><code>ShippingCartAddress</code></a> , qui indique si les adresses d’expédition et de facturation sont identiques.</li>
                <li><!--LYNX-458-->Mise à jour des requêtes <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order"><code>guestOrder</code></a> et <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order-by-token"><code>guestOrderByToken</code></a> afin d’inclure des attributs d’adresse personnalisés, garantissant ainsi des informations d’adresse complètes pour les nouveaux comptes.</li>
            </ul>
        </td>
    </tr>
    <tr>
