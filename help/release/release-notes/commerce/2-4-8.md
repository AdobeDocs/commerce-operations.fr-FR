    ...
    <tbody>
        ...
        <td>
            <ul>
              ...
              <li><!--LYNX-731-->Ajout de la prise en charge de GraphQL pour la récupération des informations de règle de panier. Ajout de nouvelles configurations de magasin pour contrôler l’exposition de toutes les règles de panier et appliquées, ainsi que de la requête <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/cart/queries/all-rules/"><code>allCartRules</code></a> et du champ de <code>Cart.rules</code> pour récupérer les règles de panier actives.</li>
            </ul>
        </td>
       </tr>
        <tr>
        ...
        <td>
            <ul>
              <li><!--LYNX-730-->Ajout de configurations de magasin pour les règles de tarification de catalogue, ajout de la requête <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/products/queries/all-rules/"><code>allCatalogRules</code></a> pour récupérer toutes les règles de catalogue disponibles et exposition du champ <code>Product.rules</code> pour afficher les règles de catalogue actuellement appliquées à un produit.</li>
