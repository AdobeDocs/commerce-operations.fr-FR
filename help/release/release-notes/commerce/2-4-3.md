...
[Live Search](https://experienceleague.adobe.com/fr/docs/commerce/live-search/overview) optimisé par [Adobe Sensei](https://www.adobe.com/sensei.html) offre une expérience de recherche intuitive en utilisant l’intelligence artificielle et des algorithmes de machine learning pour effectuer une analyse approfondie des données agrégées du visiteur. Voir [Notes de mise à jour de Live Search](https://experienceleague.adobe.com/docs/commerce/live-search/release-notes.html?lang=fr).
