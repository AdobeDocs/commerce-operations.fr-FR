...
[Live Search](https://docs.magento.com/user-guide/live-search/overview.html) optimisée par [Adobe Sensei](https://www.adobe.com/sensei.html) offre une expérience de recherche intuitive à l’aide d’une intelligence artificielle et d’algorithmes d’apprentissage automatique pour effectuer une analyse approfondie des données agrégées sur les visiteurs. Voir [Notes de mise à jour de la recherche en direct](https://experienceleague.adobe.com/docs/commerce-merchant-services/live-search/release-notes.html).
...
* **Listes de souhaits**. La [mutation addWishlistItemsToCart](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-wishlist-items-to-cart.html) déplace les éléments de la liste de souhaits spécifiée vers le panier du client. <!-- magento/partners-magento2ee#449-->

* **Enregistrements de cadeau**. Les tâches couvertes sont les suivantes : <!-- PWA-1290-->

   * Utilisez la [requête de registre des cadeaux](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry.html) pour renvoyer le contenu des registres des cadeaux du client.
   ...
   * [Créez](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-gift-registry.html), [mettez à jour](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry.html) ou [supprimez](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry.html) des registres de cadeaux.

   * [Mettre à jour](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry-items.html) ou [supprimer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry-items.html) des éléments d’un registre des cadeaux.

   * [Déplacez tous les articles](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-cart-items-to-gift-registry.html) du panier vers le registre des cadeaux. <!-- ENGCOM-9082 9087-->

   * [Ajoutez ](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-gift-registry-registrants.html), [mettez à jour](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry-registrants.html) ou [supprimez](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry-registrants.html) les inscrits d&#39;un registre de cadeaux.

   * [Partager](https://devdocs.magento.com/guides/v2.4/graphql/mutations/share-gift-registry.html) un registre des cadeaux avec les invités.

* **Guillemets négociables**. Voir les requêtes [`negotiableQuote`](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quote.html) et [`negotiableQuotes`](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quotes.html) . <!-- PWA-1292-->
