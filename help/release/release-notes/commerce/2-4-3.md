...
* La réponse à la variable `{ category(id: 2){ children { name children { name } } } }` La requête GraphQL comprend désormais une arborescence de catégories correctement triée.
