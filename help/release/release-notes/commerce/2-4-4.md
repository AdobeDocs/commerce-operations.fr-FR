...
PWA Studio v.12.3.0 est compatible avec Adobe Commerce 2.4.4. Elle prend en charge reCaptcha, l’optimisation du contenu de Page Builder et le contenu personnalisé. Pour plus d’informations sur les améliorations et les correctifs, voir [Versions de &#x200B;](https://github.com/magento/pwa-studio/releases). Consultez [Compatibilité des versions](https://developer.adobe.com/commerce/pwa-studio/integrations/adobe-commerce/version-compatibility/) pour obtenir la liste des versions de PWA Studio et de leurs versions principales d’Adobe Commerce compatibles.
...
* La méthode `str_contains` non prise en charge a été remplacée par une fonction prise en charge. Il s’agissait d’un problème connu d’Adobe Commerce 2.4.3. [GitHub-33680](https://github.com/magento/magento2/issues/33680)
...
* Mise à jour du métapaquet racine `composer.json` et du fichier `composer.json` pour chaque module vers PHP 8.1. [GitHub-34009](https://github.com/magento/magento2/issues/34009)
