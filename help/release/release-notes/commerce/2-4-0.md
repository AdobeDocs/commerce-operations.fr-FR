...
Consultez le [Guide du développeur de GraphQL](https://devdocs.magento.com/guides/v2.4/graphql/) pour plus d’informations à ce sujet et sur d’autres améliorations. Voir les [notes de mise à jour](https://devdocs.magento.com/guides/v2.4/graphql/release-notes.html) pour une discussion détaillée sur les correctifs de bogues récents de GraphQL.
