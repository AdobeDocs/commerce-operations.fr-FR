...
**Avec cette version, les intégrations Authorize.Net, eWay, CyberSource et Worldpay ont été supprimées du code principal. Les commerçants doivent migrer vers les extensions officielles disponibles sur le**.
...
* **Décomposition des contrôleurs** permet aux développeurs d’extensions d’implémenter ActionInterface directement sans classes de « supertype de couche ». Voir l’article archivé [Décomposition des contrôleurs](https://lbajsarowicz.me/blog/decomposition-of-magento-controllers/) DevBlog . _Amélioration démarrée par Vinai Kopp dans la demande de tirage [16268](https://github.com/magento/magento2/pull/16268) et finalisée par Lukasz Bajsarowicz dans la demande de tirage [26778](https://github.com/magento/magento2/pull/26778)_. [GitHub-9582](https://github.com/magento/magento2/issues/9582)
* **Décomposition des contrôleurs** permet aux développeurs d’extensions d’implémenter ActionInterface directement sans classes de « supertype de couche ». Voir l’article archivé [Décomposition des contrôleurs](https://lbajsarowicz.me/blog/decomposition-of-magento-controllers/) DevBlog . _Amélioration démarrée par Vinai Kopp dans la demande de tirage [16268](https://github.com/magento/magento2/pull/16268) et finalisée par Lukasz Bajsarowicz dans la demande de tirage [26778](https://github.com/magento/magento2/pull/26778)_. [GitHub-9582](https://github.com/magento/magento2/issues/9582)
...
* **Suppression de l’intégration principale des modes de paiement tiers**. Avec cette version, l&#39;intégration de la méthode de paiement Authorize.Net a été supprimée du code principal. Les commerçants doivent migrer vers l’extension officielle disponible sur le Commerce Marketplace. Consultez l’article de blog de développement archivé [Obsolescence des intégrations de paiement](https://experienceleague.adobe.com/fr/docs/commerce-admin/start/compliance/payments/compliance-payment-services-directive). <!-- MC-29029-->
* **Suppression de l’intégration principale des modes de paiement tiers**. Avec cette version, l&#39;intégration de la méthode de paiement Authorize.Net a été supprimée du code principal. Les commerçants doivent migrer vers l’extension officielle disponible sur le Commerce Marketplace. <!-- MC-29029-->
...
Cette extension groupée remplace notre intégration Braintree principale, qui a été supprimée dans cette version. Voir [Paiements &#x200B;](https://commercemarketplace.adobe.com//paypal-module-braintree.html).
