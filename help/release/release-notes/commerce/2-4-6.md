...
## Environnement de test bêta 2.4.6

Adobe Commerce 2.4.6-beta a été testé par rapport aux versions de composants suivantes :
...
Adobe Commerce 2.4.6-beta5 prend désormais en charge :
...
Nous corrigeons des centaines de problèmes dans le code principal Adobe Commerce 2.4.6. Vous trouverez ci-dessous un sous-ensemble des problèmes résolus inclus dans Adobe Commerce 2.4.6-beta.
...
* Suppression d’une version fixe de la dépendance du Sniffer de code PHP de la principale version du projet Magento 2. `composer.json` fichier . [GitHub-35994](https://github.com/magento/magento2/issues/35994)

<!-- AC-7300-->

* Suppression de la manipulation inutile de `version` clés depuis l’intérieur de `sampledata:deploy`. Auparavant, l’exécution de `bin/magento sampledata:deploy` a généré un message d’erreur indiquant qu’un `version` clé manquante dans `composer.json`. Une fois la commande exécutée, Adobe Commerce confirme désormais la réussite et indique les prochaines étapes à suivre. [GitHub-36554](https://github.com/magento/magento2/issues/36554)
...
* Mise à jour du code de conduite du projet (`CODE_OF_CONDUCT.md`). [GitHub-36639](https://github.com/magento/magento2/issues/36639)

<!-- AC-7500-->

* Le modèle de code des mots-clés Google a été restructuré afin d’améliorer la lisibilité et de remplacer les fonctions d’échappement obsolètes par des fonctions correctes. [GitHub-36641](https://github.com/magento/magento2/issues/36641)
...
* Le `Fixex.io` le service d’importation fonctionne désormais comme prévu. Les taux de change sont maintenant importés avec succès. [GitHub-36010](https://github.com/magento/partners-magento2ee/issues/36010)
...
* Les régions ISO 3166 pour la République tchèque ont été ajoutées au `directory_country_region` table. [GitHub-36346](https://github.com/magento/magento2/issues/36346)
