...
Cette version comprend plusieurs correctifs de bogues. Voir les [notes de mise à jour B2B](https://experienceleague.adobe.com/docs/commerce-admin/b2b/release-notes.html?lang=fr).
...
2. Suivez les étapes de mise à niveau décrites dans la phase de gestion des packages du processus de mise à niveau [Effectuer une mise à niveau](https://experienceleague.adobe.com/docs/commerce-operations/upgrade-guide/implementation/perform-upgrade.html?lang=fr).
