...
* La grille de page CMS filtre désormais les pages en fonction de la vue de magasin attribuée à l’utilisateur administrateur. Auparavant, la portée du rôle n’était pas appliquée.
...
* Adobe Commerce ne renvoie plus d’erreur de violation de contrainte lorsque vous désélectionnez une page, puis sélectionnez une page CMS nouvellement créée.
