...
* L’en-tête X-Magento-Cache-Id a été supprimé des réponses de mutation de GraphQL. Étant donné que les mutations sont des opérations qui modifient l’état (comme l’ajout d’articles au panier ou le passage d’une commande), elles ne sont pas censées être mises en cache. L’inclusion de cet en-tête était trompeuse et pouvait entraîner un comportement incorrect si la mise en cache était appliquée. Cette modification s’aligne sur les bonnes pratiques de GraphQL et les principes fondamentaux de l’architecture d’Adobe Commerce.
