...
* Ajout de la prise en charge de plusieurs listes de souhaits. Vous pouvez utiliser GraphQL pour [créer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-wishlist.html), [supprimer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-wishlist.html) et [renommer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-wishlist.html) listes de souhaits, ainsi que pour [déplacer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-products-between-wishlists.html) ou [copier](https://devdocs.magento.com/guides/v2.4/graphql/mutations/copy-products-between-wishlists.html) éléments entre eux. <!-- MC-32356-->

* Ajout de la prise en charge des autorisations de marchandisage renvoyées (RMA). Les acheteurs peuvent [demander un retour](https://devdocs.magento.com/guides/v2.4/graphql/mutations/request-return.html). Si le commerçant accepte la demande, l&#39;acheteur peut effectuer des tâches telles que [ajouter un commentaire](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-return-comment.html) et [ajouter des informations de suivi](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-return-tracking.html). <!-- MC-34596-->

* Ajout de la prise en charge des fonctionnalités B2B suivantes :
   * Entreprises. Vous pouvez ajouter les [administrateurs](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company.html), [utilisateurs](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-user.html), [rôles](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-role.html) et [équipes](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-company-team.html). <!-- MC-33861-->
   * Crédit de l’entreprise. La [requête de la société](https://devdocs.magento.com/guides/v2.4/graphql/queries/company.html) comprend des détails sur l’historique de crédit de la société. <!-- MC-33862-->
   * Listes de demandes d’approvisionnement. Vous pouvez [créer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-requisition-list.html), [supprimer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-requisition-list.html) et [mettre à jour](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-requisition-list.html) des listes de demande. La prise en charge inclut également la possibilité de [ajouter](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-products-to-requisition-list.html), [mettre à jour](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-products-in-wishlist.html), [supprimer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-requisition-list-items.html), [copier](https://devdocs.magento.com/guides/v2.4/graphql/mutations/copy-items-between-requisition-lists.html) et [déplacer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-items-between-requisition-lists.html) éléments dans une liste de demandes et d’ajouter des éléments de liste de demandes [ dans le panier](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-requisition-list-items-to-cart.html). <!-- MC-34312-->

* Prise en charge des unions dans GraphQL. [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* Ajout de la prise en charge des [listes de comparaison](https://devdocs.magento.com/guides/v2.4/graphql/queries/compare-list.html). Les acheteurs peuvent [créer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-compare-list.html) et [supprimer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/delete-compare-list.html) listes de comparaison, et [ajouter](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-products-to-compare-list.html) et [supprimer](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-products-from-compare-list.html) éléments dans les listes de comparaison. En outre, les acheteurs qui créent une liste de comparaison en tant qu’invités peuvent se connecter en tant que client et [conserver](https://devdocs.magento.com/guides/v2.4/graphql/mutations/assign-compare-list-to-customer.html) leurs listes de comparaison.

* Ajout de la mutation [`generateCustomerTokenAsAdmin`](https://devdocs.magento.com/guides/v2.4/graphql/mutations/generate-customer-token-as-admin.html) et mise à jour de l’objet `Customer` pour prendre en charge l’assistance à l’achat à distance.
...
**Les commandes peuvent désormais être effectuées à l’aide de méthodes de paiement en ligne**. Les acheteurs B2B sont invités à sélectionner leur mode de paiement préféré pour chaque [commande](https://docs.magento.com/user-guide/stores/b2b-purchase-order-flow.html) au cours du passage en caisse initial. Une fois la commande approuvée, les acheteurs sont invités à saisir les détails du paiement pour convertir la commande en commande finale.
...
* Le Créateur de pages n’a plus besoin de placer tous les types de contenu dans une ligne. L’ [ étape du créateur de pages](https://docs.magento.com/user-guide/cms/page-builder-workspace.html#stage) est maintenant initialement vide et prend en charge l’ajout direct des types de contenu suivants à l’étape : lignes, colonnes, onglets, code d’HTML, blocs, blocs dynamiques.

* Les marges et les plages prédéfinies ne sont plus nécessaires pour les types de contenu.

* Le nouveau [sélecteur de fenêtre d’affichage](https://docs.magento.com/user-guide/cms/page-builder-workspace.html#viewports) mobile et la portée de fenêtre d’affichage pour les valeurs de champ de formulaire permettent aux utilisateurs et aux développeurs d’effectuer les actions suivantes :
...
* La nouvelle classe `BlockByIdentifier` prend en charge la récupération d’un bloc de mise en page à partir de l’identifiant de bloc CMS. Par conséquent, lorsqu’un bloc CMS est supprimé du cache, l’application efface également le cache du bloc de mise en page. [GitHub-28309](https://github.com/magento/magento2/issues/28309)
