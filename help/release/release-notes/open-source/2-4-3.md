...
La portée de l’[outil de compatibilité de mise à niveau](https://experienceleague.adobe.com/docs/commerce-operations/upgrade-guide/upgrade-compatibility-tool/overview.html?lang=fr) a été étendue en fonction des commentaires de la communauté. Rejoignez notre canal de Slack [#upgrade-compatibility-tool](https://magentocommeng.slack.com/archives/C019Y143U9F) pour obtenir l’assistance de l’équipe produit de l’Adobe et de la communauté, ainsi que pour orienter l’orientation future de l’outil.
