...
* L’application affiche désormais une **Numéro de TVA** sur la page d’enregistrement du client lorsque `customer/create_account/vat_frontend_visibility` est activée.
...
* Les crochets ajoutés aux chaînes ne sont plus ignorés lors de la configuration de la traduction intégrée. Auparavant, la variable `escapeHtmlAttr` convertit les crochets en codes d’entité de HTML.
