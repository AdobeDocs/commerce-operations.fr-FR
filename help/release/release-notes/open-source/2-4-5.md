...
Consultez le [Bulletin de sécurité d’](https://helpx.adobe.com/fr/security/products/magento/apsb22-38.html) pour connaître la dernière discussion sur ces problèmes résolus.
...
Consultez le [Guide du développeur de &#x200B;](https://developer.adobe.com/commerce/webapi/graphql/) pour plus d’informations sur ces améliorations.
...
Pour plus d’informations sur les améliorations et les correctifs, voir [Versions de &#x200B;](https://github.com/magento/pwa-studio/releases). Consultez [Compatibilité des versions](https://developer.adobe.com/commerce/pwa-studio/integrations/adobe-commerce/version-compatibility/) pour obtenir la liste des versions de PWA Studio et de leurs versions principales de Magento Open Source compatibles.
...
* Un nouveau cache de produit est maintenant généré avec succès après l’ajout d’une nouvelle image avec un nom contenant « . » à un produit, puis enregistrement du produit et nettoyage du cache d’images. [GitHub-32699](https://github.com/magento/magento2/issues/32699)
...
* La méthode `isFreeShipping` renvoie désormais un entier plutôt qu’un Boolean.[GitHub-35164](https://github.com/magento/magento2/issues/35164)
...
* Les prix des produits virtuels sont désormais exclus dans le tableau de calcul du montant d&#39;expédition des taux. Auparavant, les coûts d’expédition de ces produits n’étaient pas calculés correctement.[GitHub-35185](https://github.com/magento/magento2/issues/35185)
...
* Les requêtes REST API bulk PUT et DELETE fonctionnent désormais comme prévu lorsque le module `Magento_ReCaptchaWebapiRest` est activé. [GitHub-35348](https://github.com/magento/magento2/issues/35348)
