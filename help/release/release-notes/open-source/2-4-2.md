...
* Les requêtes pour les données `categories.breadcrumbs` d’un produit ne renvoient plus de données de chemin de navigation pour les catégories dont la catégorie parente est désactivée. [GitHub-30468](https://github.com/magento/magento2/issues/30468)
...
* La requête `products` renvoie désormais les résultats attendus lorsque la fonction `category_id`  est spécifié avec le mot-clé `in` . [GitHub-30349](https://github.com/magento/magento2/issues/30349)
