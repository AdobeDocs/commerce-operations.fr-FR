...
description: Découvrez les nouvelles fonctionnalités, les améliorations, les correctifs de bogues et les problèmes connus de la version 2.4.2 du Magento Open Source.
...
Magento Open Source 2.4.2 comprend des améliorations des performances et de la sécurité ainsi que des améliorations importantes de la plateforme. Les améliorations de sécurité incluent l’extension de la prise en charge de la variable `SameSite` pour tous les cookies. Elasticsearch 7.9.x et Redis 6.x sont désormais pris en charge.
...
Cette version contient des améliorations de la qualité de base, qui améliorent la qualité du framework et les domaines fonctionnels suivants : Compte client, catalogue, CMS, OMS, Import/Export, Promotions et Ciblage, Panier et Passage en caisse.
...
* La possibilité de configurer une installation pour utiliser une base de données partagée est désormais obsolète dans cette version. Voir [Abandon de la fonctionnalité de base de données partagée dans Magento Open Source](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187) Publication DevBlog .
...
* L’application ne renvoie plus d’erreur lorsque vous essayez de modifier `backend-frontname` en utilisant la variable `ssh` après l’installation de Magento Open Source. [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* Le **Ajouter au panier** fonctionne désormais comme prévu chaque fois que la fonction **Ajouter au panier** est disponible en cliquant sur . Auparavant, si vous cliquiez plusieurs fois sur ce bouton en attendant le chargement d’une page de produit, l’application générait cette erreur : `Invalid Form Key. Please refresh the page`.
...
* L’application ne répertorie plus un produit téléchargeable dans l’onglet Mes produits de téléchargement une fois que la commande à laquelle elle appartient a été partiellement remboursée. [GitHub-28388](https://github.com/magento/magento2/issues/28388)
...
* Le résolveur d’URL GraphQL gère désormais correctement les paramètres de requête. Auparavant, il renvoyait la valeur NULL lors de la gestion des URL compatibles SEO avec des paramètres.
...
* Requêtes pour un produit `categories.breadcrumbs` Les données ne renvoient plus de données de chemin de navigation pour les catégories dont la catégorie parente est désactivée. [GitHub-30468](https://github.com/magento/magento2/issues/30468)

<!-- MC-38407-->

* Le chemin d’accès à une image de catégorie est désormais renvoyé correctement lorsque les réécritures d’URL sont désactivées.
...
* Le `FlushCacheByTags` a été mise à jour afin d’utiliser les plug-ins &quot;after-plug-ins&quot; plutôt que les plug-ins &quot;contourner&quot;. [GitHub-29558](https://github.com/magento/magento2/issues/29558)
...
* Les valeurs d’en-tête contenant des URL sont désormais correctement analysées dans `ApiFunctional TestFramework`. [GitHub-26425](https://github.com/magento/magento2/issues/26425)
...
Vous pouvez installer Magento Open Source 2.4.2 à l’aide de [Compositeur](../../../installation/composer.md).
