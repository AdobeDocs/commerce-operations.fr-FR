...
* Les opérations du système de fichiers sur tous les composants ont été normalisées et renforcées afin d’éviter les chargements malveillants.
...
Cette version contient des améliorations de la qualité de base, qui améliorent la qualité du framework et ces domaines fonctionnels : compte client, catalogue, CMS, OMS, Import/Export, Promotions et Ciblage, Panier et Passage en caisse.
...
* La variable **Ajouter au panier** fonctionne désormais comme prévu chaque fois que la fonction **Ajouter au panier** est disponible en cliquant sur . Auparavant, si vous cliquiez plusieurs fois sur ce bouton en attendant le chargement d’une page de produit, l’application générait cette erreur : `Invalid Form Key. Please refresh the page`.
...
* La variable `FlushCacheByTags` a été mise à jour afin d’utiliser les plug-ins &quot;after-plug-ins&quot; plutôt que les plug-ins &quot;contourner&quot;. [GitHub-29558](https://github.com/magento/magento2/issues/29558)
