...
* Cette version ne permet plus de configurer une installation pour utiliser une base de données fractionnée. Pour obtenir des instructions sur la migration](../../../configuration/storage/revert-split-database.md) voir [Rétablir une base de données fractionnée en une seule base de données.
