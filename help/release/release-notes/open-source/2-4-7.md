...
* **Limites du nombre de codes de bon générés automatiquement**. Magento Open Source limite désormais le nombre de codes de bons générés automatiquement. La valeur par défaut maximale est de 250 000. Les commerçants peuvent utiliser la nouvelle option de configuration **[!UICONTROL Code Quantity Limit]** (**[!UICONTROL Stores]** > **[!UICONTROL Settings:Configuration]** > **[!UICONTROL Customers]** > **[!UICONTROL Promotions]**) pour éviter de surcharger le système avec de nombreux coupons. <!-- AC-8753 -->
...
* Les délais de chargement des pages de passage en caisse ont été améliorés pour les clients disposant de grands carnets d’adresses. Magento Open Source traite désormais uniquement le nombre d’adresses de client spécifié dans le paramètre **[!UICONTROL Customer Addresses Limit]**. Auparavant, Magento Open Source chargeait l’intégralité du carnet d’adresses.
...
* La requête `products` renvoie désormais les libellés corrects. [GitHub-29635](https://github.com/magento/magento2/issues/29635)
...
* Ajout de régions ukrainiennes à la table `directory_country_region`. [GitHub-35187](https://github.com/magento/magento2/issues/35187)
...
* Les vendeurs peuvent désormais informer les acheteurs qu’une commande est prête à être récupérée lorsque le paramètre **[!UICONTROL No Manage Stock]** est activé pour un produit. Auparavant, lorsque ce paramètre était activé, Magento Open Source affichait ce message d’erreur : `Your order is not ready for pickup`.
