---
title: Notes de mise à jour de Magento Open Source 2.4.7-bêta3
description: Découvrez les nouvelles fonctionnalités, les améliorations, les correctifs de bogues et les problèmes connus de la version 2.4.7-beta3 du Magento Open Source.
...
# Notes de mise à jour de Magento Open Source 2.4.7-bêta3
...
Magento Open Source 2.4.7-beta3 introduit la prise en charge de PHP 8.3. Il comprend plus de 150 correctifs de qualité et améliorations. Les dépendances du compositeur principal et les bibliothèques tierces ont été mises à niveau vers les dernières versions disponibles.
...
Magento Open Source 2.4.7-beta3 a été testé par rapport aux versions de composants suivantes :
...
## Faits saillants de Magento Open Source 2.4.7-beta3
...
Magento Open Source 2.4.7-beta3 comprend les mises à niveau de plateforme suivantes :
...
Magento Open Source 2.4.7-beta3 est toujours compatible avec PHP 8.1 à des fins de mise à niveau uniquement. PHP 8.1 n’est pas pris en charge et n’est pas recommandé. Le code principal Magento Open Source 2.4.7-beta3, toutes les extensions groupées, ainsi que toutes les extensions détenues par l’Adobe et tous les services SaaS sont compatibles avec PHP 8.3. <!-- AC-9668 -->

* **Prise en charge de RabbitMQ 3.11**. Cette version est compatible avec la dernière version de RabbitMQ 3.11. La compatibilité reste avec RabbitMQ 3.9, qui est pris en charge jusqu’en août 2023, mais nous vous recommandons d’utiliser Magento Open Source 2.4.7-beta3 uniquement avec RabbitMQ 3.11.

* **Compositeur 2.6.x**. La compatibilité avec le compositeur 2.2.x demeure. <!-- AC-9663 -->

* **Prise en charge du cache 7.4 de vernis**. Cette version est compatible avec la dernière version de Varnish Cache 7.4. La compatibilité reste avec les versions 6.0.x et 7.2.x, mais nous vous recommandons d’utiliser Magento Open Source 2.4.7-beta3 uniquement avec Varnish Cache version 7.4 ou la version 6.0 LTS. <!-- AC-9662 -->
...
* L’intégration de Magento Open Source avec FedEx a été migrée des services Web WSDL hérités de FedEx vers les dernières API RESTful de FedEx. Le suivi des services Web FedEx, la validation des adresses et la validation des codes postaux seront retirés en mai 2024. <!-- AC-1470 -->
...
Magento Open Source 2.4.7 inclut des fonctionnalités de mise en cache GraphQL améliorées, la prise en charge du schéma GraphQL pour les attributs personnalisés, la prise en charge de l’annulation de commande sans interface utilisateur graphique et l’amélioration de la mise en cache du résolveur.
...
Vous pouvez installer Magento Open Source 2.4.7-bêta3 à l’aide de [Compositeur](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html).
