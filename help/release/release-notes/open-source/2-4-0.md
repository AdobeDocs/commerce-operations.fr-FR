...
* **Suppression de l’intégration principale des modes de paiement tiers**. Avec cette version, l&#39;intégration de la méthode de paiement Authorize.Net a été supprimée du code principal. Les commerçants doivent migrer vers l’extension officielle disponible sur le Commerce Marketplace. Pour plus d&#39;informations, consultez la section [Obsolescence des intégrations de paiement](https://experienceleague.adobe.com/fr/docs/commerce-admin/start/compliance/payments/compliance-payment-services-directive).<!-- MC-29029-->
...
Les améliorations d’Inventory management pour cette version comprennent la prise en charge du retrait en magasin et la prise en charge des produits groupés. Voir les [notes de mise à jour d’](https://experienceleague.adobe.com/docs/commerce-admin/inventory/release-notes.html?lang=fr) pour une discussion plus détaillée des correctifs Inventory management récents.
...
Voir le [Guide du développeur de &#x200B;](https://developer.adobe.com/commerce/webapi/graphql/) pour plus d’informations à ce sujet et sur d’autres améliorations. Voir [Notes de mise à jour](https://developer.adobe.com/commerce/webapi/graphql/release-notes/) pour une discussion détaillée des correctifs GraphQL récents.
...
Cette version d’comprend des extensions développées par des fournisseurs tiers. Elle introduit à la fois des améliorations de qualité et d&#39;expérience utilisateur dans ces extensions et une extension de la couverture MFTF.
...
* Mises à jour des CSP
* Possibilité d&#39;effectuer plusieurs autorisations pour une commande multiarticle
* Prise en charge des adresses japonaises

#### Braintree Payments

Cette extension remplace notre intégration Braintree principale. Il fournit les mêmes fonctionnalités que l’intégration principale de Braintree. Voir [Paiements &#x200B;](https://commercemarketplace.adobe.com//paypal-module-braintree.html).
...
L’installation de Magento Open Source s’est maintenant terminée avec succès et les magasins sont créés comme prévu, lorsque la configuration du magasin est prédéfinie dans `config.php`.
...
* Le tableau de bord Mon compte affiche désormais correctement les valeurs des adresses e-mail en mode mobile. _Correctif soumis par Eden Duong dans la demande de tirage [25942](https://github.com/magento/magento2/pull/25942)_. [GitHub-25935](https://github.com/magento/magento2/issues/25935)
...
* L’application ne prend plus en charge l’héritage des classes DTO de la classe `Magento\Framework\Api\AbstractExtensibleObject`. L’annotation PHP manquante `@api` a été ajoutée à `AbstractExtensibleModel`, et l’annotation `@deprecated` manquante a été ajoutée à `AbstractExtensibleObject`.  _Correctif soumis par Alexander Taranovsky dans la demande de tirage [22011](https://github.com/magento/magento2/pull/22011)_. [GitHub-22010](https://github.com/magento/magento2/issues/22010)
...
* La mise en œuvre de base de la protection contre la fraude par Signifyd n&#39;est plus prise en charge. Les commerçants doivent migrer vers l’extension [Protection contre la fraude et les refacturations Signifyd](https://commercemarketplace.adobe.com//signifyd-module-connect.html) disponible sur Commerce Marketplace.
...
* Les commandes terminées apparaissent désormais dans le système de paiement et dans Magento Open Source. Auparavant, les commandes apparaissaient dans le système de paiement, mais pas dans Magento Open Source. [GitHub-25862](https://github.com/magento/magento2/issues/25862)
...
* Elasticsearch 7.6.x est désormais le moteur de recherche catalogue par défaut pour Adobe Commerce et Magento Open Source. Vous ne pouvez pas installer ni mettre à niveau vers la version 2.4.0 sans installer également Elasticsearch 7.6.x. Le code de la version 2.x d’Elasticsearch a été supprimé. Les versions 5.x et 6.x d’Elasticsearch sont obsolètes et ne sont plus prises en charge. Voir [Conditions préalables relatives aux moteurs de recherche](../../../installation/prerequisites/search-engine/overview.md).
...
**Problème** : les commerçants ne peuvent pas créer de nouvelle commande à partir de l’administrateur, car les boutons **Ajouter des produits par SKU** et **Ajouter des produits** sont absents de la page de création de commande lorsque le regroupement JavaScript est activé.  **Solution** : désactivez le regroupement JavaScript pour votre déploiement. <!-- MC-36044-->
