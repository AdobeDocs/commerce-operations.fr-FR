...
Cette extension remplace notre intégration Braintree principale. Il fournit les mêmes fonctionnalités que l’intégration principale de Braintree. Voir [Paiements Braintree](https://marketplace.magento.com/paypal-module-braintree.html).
