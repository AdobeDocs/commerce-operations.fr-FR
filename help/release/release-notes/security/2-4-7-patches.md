...
>
>À compter de cette date, Adobe Commerce 2.4.7 ne fournira ni compatibilité ni prise > charge des versions de MySQL publiées après MySQL 8.0. Adobe ne > pas valider ni fournir de prise en charge des versions majeures MySQL plus récentes sur cette ligne de version d’Adobe>Commerce.
>
>Il est vivement conseillé à tous les clients sur site Adobe Commerce exécutant la version 2.4>7 de migrer leurs serveurs de base de données vers une version MariaDB compatible.
