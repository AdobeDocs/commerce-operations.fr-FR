...
>
>À compter de cette date, Adobe Commerce version 2.4.7 ne fournira plus de compatibilité ou
...
>
>Tous les clients et clientes Adobe Commerce On-Premise exécutant la version 2.4.7 ont une
...
Pour faire face à la mise hors service de Laminas MVC, Adobe Commerce utilise désormais un formulaire de `laminas-mvc` détenu par Magento (publié sous la forme `magento/magento-zf-mvc`). Ce branchement assure la conformité continue des correctifs et de la sécurité à long terme pour Adobe Commerce 2.4.7.
