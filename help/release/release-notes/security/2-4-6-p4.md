---
title: Notes de mise à jour d’Adobe Commerce 2.4.6-p4
description: Découvrez les correctifs pour les problèmes de sécurité dans la version 2.4.6-p4 d’Adobe Commerce.
...
# Notes de mise à jour d’Adobe Commerce 2.4.6-p4

Adobe Commerce 2.4.6-p4 est une version de sécurité qui fournit cinq correctifs de sécurité qui améliorent votre déploiement Adobe Commerce 2.4.6 ou Magento Open Source 2.4.6. Il fournit des correctifs pour les vulnérabilités qui ont été identifiées dans les versions précédentes.
