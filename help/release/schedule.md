...
- **Correctifs de sécurité isolés**—Les correctifs de sécurité individuels, non cumulatifs [correctifs de sécurité](versioning-policy.md#isolated-patch) sont publiés selon les besoins et incluent des correctifs de sécurité pour toutes les lignes de version [prises en charge](lifecycle-policy.md) (comprend une prise en charge régulière et étendue).
...
- **Correctifs Beta**—Deux correctifs [bêta](versioning-policy.md#beta-patch-release) pour la ligne de version Adobe Commerce 2.4.x LTS sont publiés deux fois par an.
