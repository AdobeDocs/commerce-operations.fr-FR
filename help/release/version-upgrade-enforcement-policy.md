...
description: 'Découvrez l’application des mises à niveau de version pour Adobe Commerce on Cloud (PaaS) : pourquoi Adobe applique-t-il les mises à niveau, les dates d’application, la désactivation et les actions requises ? Consultez la politique relative au cycle de vie pour connaître les dispositions transitoires et les chemins de migration.'
...
# Politique d’application de la mise à niveau de version pour Adobe Commerce on Cloud (PaaS)

Lorsque la prise en charge régulière et la prise en charge étendue d’une version d’Adobe Commerce prennent fin, Adobe se réserve le droit de désactiver Adobe Commerce sur le cloud (PaaS) les environnements qui exécutent toujours cette version non prise en charge. L’application de la mise à niveau de version s’applique uniquement aux environnements PaaS hébergés par Adobe ; les clients sur site gèrent leur propre infrastructure.
...
**Date d’application de la mise à niveau** = Date de disponibilité générale + 3 ans d’assistance régulière + 1 an d’assistance étendue
...
À la date d’application de la mise à niveau publiée, Adobe arrêtera la maintenance de tous les environnements Adobe Commerce on Cloud (PaaS) exécutant toujours la version affectée et se réserve le droit de les désactiver. Vous recevrez des notifications avancées aux jalons clés menant à la date d’application de la mise à niveau de version. Adobe fournit une fenêtre d’exportation des données avant la désactivation de l’environnement afin que vous puissiez récupérer vos données.
