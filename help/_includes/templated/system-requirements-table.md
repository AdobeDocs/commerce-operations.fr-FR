...
<table style="table-layout:auto">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          8.0.mysql_aurora.3.09 ou version la plus récente disponible
      </td>
      <td>
          8.0.mysql_aurora.3.09 ou version la plus récente disponible
      </td>
      <td>
          8.0.mysql_aurora.3.08 ou version la plus récente disponible
      </td>
      <td>
          8.0.mysql_aurora.3.08 ou version la plus récente disponible
      </td>
    ...
    <tr>
      ...
      <td>
          ElastiCache version 7.1 pour Redis OSS (amélioré). Valkey 8 est disponible.
      </td>
      <td>
          ElastiCache version 7.1 pour Redis OSS (amélioré)
      </td>
      <td>
          ElastiCache version 7.1 pour Redis OSS (amélioré)
      </td>
    ...
    <tr>
      ...
      <td>
          Version 2.19 ou ultérieure disponible
      </td>
      <td>
          Version 2.19 ou ultérieure disponible
      </td>
...
<table style="table-layout:auto">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          Version 2.17 ou ultérieure disponible
      </td>
      <td>
          Version 2.19 ou ultérieure disponible
      </td>
