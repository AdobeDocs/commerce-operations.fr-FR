...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Mise à jour du planning de publication du correctif <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/release/planning/schedule"></a> afin de prendre en compte les plans de publication de 2026.</p>
</td>
      <td>
        Technique, commentaires
      </td>
