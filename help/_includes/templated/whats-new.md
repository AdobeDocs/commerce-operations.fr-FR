...
<table style="table-layout:auto;">
  ...
  <tbody>
    ...
    <tr>
      <td><p>Mise à jour de la <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/system-requirements">configuration requise</a> conformément à la version du correctif de juin 2024. Modification de la représentation des tableaux de configuration requise.</p>
</td>
      <td>technique</td>
    ...
    <tr>
      <td><p>Mise à jour de la prise en charge de RabbitMQ dans les versions 2.4.5-p7 et 2.4.5-p8 dans <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/system-requirements">configuration requise</a>.</p>
</td>
      <td>technique</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Ajout de <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/release/beta">informations bêta</a> pour l’intégration Experience Manager Assets pour Commerce (version bêta privée).</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Ajout d’instructions pour la <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/tutorials/extensions">désinstallation</a> des extensions tierces.</p>
</td>
      <td>major-update</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Clarification de la prise en charge des dépendances tierces dans la <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/release/planning/lifecycle-policy">stratégie de cycle de vie des logiciels</a>.</p>
</td>
      <td>major-update</td>
