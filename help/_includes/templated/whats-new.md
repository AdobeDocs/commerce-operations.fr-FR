...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Ajout <code class="language-plaintext highlighter-rouge">catalog/seo/generate_category_product_rewrites</code> au <a href="https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/paths/config-reference-catalog.html">référence du chemin de configuration du catalogue</a>.</p>
</td>
      <td>technique</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Autres mises à jour de la version 2.4.6 :<br />- <a href="https://experienceleague.adobe.com/docs/commerce-operations_en/reference/commerce-on-premises.html">bin/magento</a><br />- <a href="https://experienceleague.adobe.com/docs/commerce-operations/release/packages/adobe-commerce.html">Packages Adobe Commerce</a><br />- <a href="https://experienceleague.adobe.com/docs/commerce-operations/release/packages/cloud.html">Packages Cloud pour Adobe Commerce</a></p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Ajoute des notes de mise à jour pour Adobe Commerce 2.4.6, Magento Open Source 2.4.6, Adobe Commerce 2.4.5-p2 et Adobe Commerce 2.4.4-p3.  Voir <a href="https://experienceleague.adobe.com/docs/commerce-operations/release/notes/overview.html">Notes de mise à jour d’Adobe Commerce et de Magento Open Source</a>.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Mise à jour des détails sur Adobe Commerce <a href="https://experienceleague.adobe.com/docs/commerce-operations/release/beta-program.html">processus de publication bêta</a>.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Ajout d’informations sur la résolution de la dégradation des performances après <a href="https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/prerequisites/database-server/mysql.html">installation</a> ou <a href="https://experienceleague.adobe.com/docs/commerce-operations/upgrade-guide/prepare/prerequisites.html">mise à niveau</a> MariaDB vers 10.4 ou 10.6.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Mise à jour des pages produit suivantes pour la version de mars 2023 :<br />- <a href="https://experienceleague.adobe.com/docs/commerce-operations/release/product-availability.html">Disponibilité du produit</a><br />- <a href="https://experienceleague.adobe.com/docs/commerce-operations/release/features.html">Fonctionnalités du produit</a><br />- <a href="https://experienceleague.adobe.com/docs/commerce-operations/release/notes/overview.html">Présentation des notes de mise à jour</a></p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Ajout de la ligne de commande <a href="https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/advanced.html">options de configuration</a> pour le moteur de recherche OpenSearch.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Ajout <a href="https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/search/configure-search-engine.html">informations</a> à propos de la prise en charge d’Elasticsearch 8.x dans 2.4.6 et <a href="https://experienceleague.adobe.com/docs/commerce-operations/upgrade-guide/prepare/prerequisites.html">instructions de mise à niveau</a>.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Mise à jour de la <a href="https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/system-requirements.html">configuration requise</a> pour les versions 2.4.5, 2.4.5-p2 et 2.4.4-p3 d’Adobe Commerce.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Ajout d’informations sur une nouvelle optimisation des performances <a href="https://experienceleague.adobe.com/docs/commerce-operations/performance-best-practices/configuration.html#customer-segments-validation">configuration du système</a>.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Ajout d’informations à propos de la prise en charge d’OpenSearch dans la version 2.4.6 au fichier <a href="https://experienceleague.adobe.com/docs/commerce-operations/implementation-playbook/overview.html">Manuel de mise en oeuvre</a> et <a href="https://experienceleague.adobe.com/docs/commerce-operations/upgrade-guide/overview.html">Guide de mise à niveau</a>.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Ajout d’une nouvelle section sur le nouveau paramètre de configuration 2.4.6 à <a href="https://experienceleague.adobe.com/docs/commerce-operations/performance-best-practices/configuration.html#limit-number-of-products-in-grid">limiter le nombre de produits dans une grille ;</a>.</p>
</td>
      <td>major-update</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Publié <a href="https://experienceleague.adobe.com/docs/commerce-operations/tools/quality-patches-tool/release-notes.html">notes de mise à jour</a> pour la version 1.1.28 du package de l’outil de correctifs de qualité (QPT).</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Ajout de la fonction <code class="language-plaintext highlighter-rouge">sales.rule.quote.trigger.recollect</code> consommateur de la file d’attente de messages au <a href="https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/message-queues/consumers.html">documentation de référence</a>.</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>Ajout d’une description d’un problème connu à la variable <a href="https://experienceleague.adobe.com/docs/commerce-operations/release/notes/adobe-commerce/2-4-6.html">Notes de mise à jour d’Adobe Commerce 2.4.6</a>.</p>
</td>
      <td>major-update</td>
