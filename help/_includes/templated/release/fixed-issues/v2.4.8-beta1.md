...
Nous avons corrigé 253 problèmes dans le code principal Adobe Commerce 2.4.8. Vous trouverez ci-dessous un sous-ensemble des problèmes résolus inclus dans cette version.
...
* _AC-12124_ : [Bogue aléatoire] La bibliothèque d’images n’est pas chargée
...
* _AC-5969_ : AlertProcessor - Argument #2 ($storeId) doit être de type int, chaîne donnée
   ...
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/commit/0574ac23>
* _AC-12880_ : All Bundled Extension Daily Build - Not generate Allure Report
   * _Note de correctif_ : le rapport d’attractivité doit être généré sans erreur
...
* _AC-12669_ : l’affirmation de la lecture des vidéos Vimeo/YouTube échoue dans les tests du générateur de pages
