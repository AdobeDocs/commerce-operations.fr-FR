...
Nous avons corrigé 279 problèmes dans le code principal Adobe Commerce 2.4.8. Vous trouverez ci-dessous un sous-ensemble des problèmes résolus inclus dans cette version.
...
* _AC-12268_ :
   * _Remarque de correctif_ : recherchez le problème de performances après la mise à niveau des dépendances du compositeur de ligue/de système de vol vers la dernière version.
...
* _AC-12715_ :
   * _Remarque :_ : recherchez les dépendances du compositeur laminas en effectuant une mise à niveau vers la dernière version
