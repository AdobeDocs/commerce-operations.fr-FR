...
La mise à jour du registre des cadeaux n’inclut plus les objets qui n’appartiennent pas au registre des cadeaux.
  _ACP2E-3495_
* __[Cloud] problème avec la fenêtre contextuelle de confirmation « Tout supprimer » suppression des éléments du panier sans confirmation__
...
* __[CLOUD] B2B : problème de catégorie via GraphQL__
...
* __Adresse d&#39;expédition vide lors de la commande d&#39;un article de registre cadeau__
...
* __L’URL du cookie YouTube ne fonctionne pas dans Page Builder__
...
* __L’aperçu de l’évaluation du contenu sur les pages de catégorie n’affiche pas les widgets de produit__
...
* __[Cloud] Les blocs dynamiques ne fonctionneront pas correctement__
...
* __La hiérarchie de page CMS peut entraîner des problèmes de réécriture d&#39;URL__
...
* __La règle de prix de catalogue ne s’affiche pas lorsqu’elle est définie pour la planification avec des blocs dynamiques__
...
* __Segment client > Condition > Historique des produits* > « Le produit a été consulté » ne fonctionne pas__
...
* __setup:upgrade échoue avec la version 11.4 de MariaDB en raison de modifications de jeu de caractères et de classement__
  _AC-13247_
...
* __Erreur de table ou de vue de base introuvable lors de l&#39;exécution de mview cron lors d&#39;une opération DDL__
...
* __2.4.8-beta1 Les rapports EE ne sont pas générés en raison d’une exception magento__
  _AC-13011_
...
Résolution du problème pour s’assurer que la miniature groupée du produit s’affiche en fonction des paramètres de configuration
  _LYNX-503_
* __Erreur lors de l’interrogation de selected_options dans OrderAddress__
...
Correction d’un problème en raison duquel les produits téléchargeables avec des options d’achat de lien distinctes activées renvoyaient 0 $ pour les articlesV2 > Total de la ligne d’origine, la plage de prix renvoyée était de 0,00 $ pour les produits avec des options de fichier ayant des prix distincts.
  _LYNX-620_
* __Schéma d’une table lorsque est créé tout nouveau et différent de lors de la mise à niveau__
...
* __Les éléments sont dupliqués après la création d’une commande à partir de l’administrateur sur le navigateur Mozilla Firefox__
...
* __[Braintree ] Rembourser la transaction de stockage en ligne en tant que transactionid-remboursement__
  _LOT-3394_
* __[Braintree] + [CLOUD] Les commandes Braintree (carte de crédit) ne peuvent pas fractionner les frais__
  _LOT-3421_
* Le certificat SSL de __[Braintree] [Cloud]Braintree expire le 30 juin__
  _LOT-3422_
...
Correction d’un problème en raison duquel le cookie private_content_version était renvoyé dans les requêtes GraphQL, même lorsque le cookie de session était désactivé. Le cookie n’est plus inclus dans les réponses de GraphQL lorsque la session est désactivée, comme prévu.
  _LYNX-339_
* __Erreur du serveur sur les props d’e-mail dans les requêtes de carte cadeau physique__
...
Correction d’un problème en raison duquel l’attribut is_available dans CartItemInterface renvoyait incorrectement la valeur true même lorsque la quantité d’articles du panier dépassait le stock vendable.
  _LYNX-382_
* L’attribut __only_x_left_in_stock dans ProductInterface n’est pas précis sur les produits configurables__
...
* Cela permet de s’assurer que les niveaux de stock sont correctement affichés pour les variations de produit configurables dans le panier et les pages de produit.
  _LYNX-403_
* __Erreur GraphQL : type de fichier non pris en charge dans la requête d&#39;options personnalisables__
...
Correction d’un problème en raison duquel l’attribut is_available dans CartItemInterface renvoyait incorrectement la valeur true même lorsque le stock vendable était inférieur à la quantité de produit demandée. Le champ is_available renvoie désormais correctement la valeur false lorsque la quantité du produit dépasse le stock disponible.
  _LYNX-420_
* __Impossible d’ajouter un coupon au panier pour l’expédition uniquement__
...
Correction d’un problème en raison duquel la mutation setShippingAddressesOnCart renvoyait une erreur lors de l’utilisation de pickup_location_code sans spécifier customer_address_id ni d’adresse. La mutation permet désormais de définir correctement une adresse d’expédition avec uniquement le code pickup_location_code.
  _LYNX-626_
* La liste __CustomerOrder.items_eligibility_for_return doit être cohérente avec les éléments de commande__
...
3. CustomerOrder.items_eligibility_for_return inclut désormais uniquement les éléments qui ne sont pas déjà en cours de retour.
   _LYNX-627_
* __Ajouter le champ quantity_return_requested__
Ajout du champ quantity_return_requested à OrderItemInterface, ce qui permet d&#39;identifier la quantité d&#39;articles pour lesquels un retour a été soumis. Cela améliore le suivi des retours avec le champ quantity_returned existant.
  _LYNX-628_
* __Les actions de commande disponible ne doivent pas contenir de RETOUR après les retours créés pour tous les articles en quantité complète__
...
Paramètre d’action ajouté pour le retour et l’annulation des liens liés aux e-mails de confirmation
  _LYNX-687_
* __L’URL de confirmation de l’utilisateur invité est redirigée vers la page de statut de la commande, car il manque orderRef (pour GuestRMA)__
...
Ajout du paramètre orderRef au lien dans l’e-mail de confirmation d’annulation de commande invité
  _LYNX-689_
* __Problèmes avec la requête du client lorsque RMA est désactivé__
Mise à jour de la logique GraphQL pour s&#39;assurer que les retours précédemment créés restent accessibles même lorsque RMA est désactivé globalement. Le message d’erreur a été supprimé pour améliorer l’expérience utilisateur de storefront, afin que les clients puissent toujours consulter leurs retours précédents.
  _LYNX-690_
* __GraphQL ne renvoie pas les données de panier mises à jour lorsque des coupons en conflit sont appliqués__
...
Correction d’un problème où les messages cadeau n’étaient pas appliqués au niveau du produit lorsqu’ils étaient désactivés au niveau mondial. Désormais, si les messages cadeau sont activés pour un produit spécifique, ils peuvent être ajoutés à l’aide de la mutation updateCartItems et seront correctement enregistrés et reflétés.
  _LYNX-714_
* __Problème lié à la suppression de l’emballage cadeau de l’article du panier__
Correction d’un problème en raison duquel la suppression de l’emballage cadeau d’un article du panier à l’aide de la mutation updateCartItems ne fonctionnait pas comme prévu. Désormais, l&#39;application et la suppression de l&#39;emballage cadeau fonctionnent correctement sans erreurs.
  _LYNX-717_
* __La fonction correspondant au client enregistré ne fonctionne pas dans Boilerplate, et la mutation trackViewedProduct doit être activée pour les invités.__
...
Correction de la requête cart.rules pour renvoyer un tableau vide au lieu d’une erreur lorsqu’aucune règle de panier active n’est appliquée.
  _LYNX-757_
* __Problème de récupération des emballages-cadeaux pour les articles du panier__
...
* __L’indexeur des règles de vente a cessé de fonctionner__
...
* __[Cloud] Produits dans la catégorie - Ajouter des produits - Attribuer - Tout sélectionner__
...
* __[CLOUD]Règle de prix de panier pour les visiteurs Segment client n’appliquant pas de remise au panier__
Le système applique désormais correctement les règles de prix du panier pour les segments de clientèle des visiteurs, même si la règle n’utilise pas de coupon, en s’assurant que les remises appropriées sont appliquées au panier. Auparavant, les remises n’étaient pas appliquées au panier pour les segments de clientèle des visiteurs, sauf si la règle de prix du panier utilisait un coupon.
  _ACP2E-2926_
* __Attribut « Type » manquant dans l’onglet « Produits à faire correspondre » des règles de produits associés__
...
* __Problème de performance sur la règle de prix de panier - Module Règle de vente anticipée__
...
* La mise à niveau de __[CLOUD] Magento entraînait le respect de la casse des coupons__
...
* __[CLOUD] Les utilisateurs administrateurs restreints peuvent voir le menu et les boutons de retour__
...
Les utilisateurs administrateurs précédemment restreints pouvaient voir le menu et les boutons de retour.
  _ACP2E-3330_
* __L’écran de retour est corrompu lors de l’actualisation de l’écran__
...
* __La règle de prix du second panier n’est pas appliquée si la règle du premier panier est déjà appliquée__
  _AC-13751_
...
* __Mises à jour des instructions de configuration « sandbox » et « prod » REST UPS dans devdoc__
  _AC-12938_
...
* __Les paramètres de mise à jour planifiée ne sont pas enregistrés s’ils ont été ajoutés initialement par la mise à jour__
Le système efface désormais correctement les valeurs des attributs de produit dans les mises à jour planifiées suivantes lorsque ces attributs sont modifiés dans la mise à jour en cours d’exécution. Auparavant, lorsqu’un attribut de produit était modifié par une mise à jour planifiée en cours d’exécution, il était impossible d’effacer ces valeurs d’attribut lors de la création d’une mise à jour planifiée, ce qui nécessitait que l’utilisateur les modifie après la création.
  _ACP2E-2901_
* __Problème de la règle de prix du panier à partir de la date et jusqu’à la date non synchronisé avec la mise à jour intermédiaire__
Les dates sont enregistrées en fonction des mises à jour de l’évaluation des règles de prix de panier.
  _ACP2E-2999_
* __Erreur JS dans l’aperçu intermédiaire__
Désormais, le fichier form-mini-stub.js se charge sans erreur de syntaxe Js dans les outils de développement.
  _ACP2E-3104_
* __Impossible de mettre à jour le contenu échelonné du prix spécial du produit__
...
* __Échec des tests d’intégration Magento\NegotiableQuote\Controller\Quote\DownloadTest::testCompanyManagerDownloadWithNQSubPermission__
  _AC-13716_
* __[Comparaison de base de données] Erreur fatale si la base de données contient un enregistrement sur la règle cible sans conditions__
