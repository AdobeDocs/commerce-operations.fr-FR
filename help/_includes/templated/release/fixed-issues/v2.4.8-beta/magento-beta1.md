...
---
# Notes de mise à jour de Magento Open Source (v2.4.8-beta1)

## Caractéristiques de la version v2.4.8-beta1

Les 49 points forts suivants s’appliquent à la version 2.4.8 de Magento Open Source.
...
* _AC-11723_ : Refactorisation de la structure de test d&#39;intégration pour la compatibilité phpunit 10 - IntegrationTest.php introuvable
   * _Remarque de correction_ : PHPUnit 9 est mis à niveau vers PHPUnit 10 avec les modifications de la structure de test d’intégration et de WebAPI d’Adobe Commerce. Les modifications de PHPUnit 10 sont rétrocompatibles.
   * _Contribution du code GitHub_ : &lt;https://github.com/magento/magento2/ (interne, non fusionné)>
* _AC-11813_ : framework de test WebApi pour la compatibilité de phpunit 10 - Problème lié à la connectivité de RabbitMQ avec les modules SOAP et B2B
   * _Remarque de correction_ : PHPUnit 9 est mis à niveau vers PHPUnit 10 avec les modifications de la structure de test d’intégration et de WebAPI d’Adobe Commerce. Les modifications de PHPUnit 10 sont rétrocompatibles.
   * _Contribution du code GitHub_ : &lt;https://github.com/magento/magento2/ (interne, non fusionné)>
* _AC-11816_ : Ajouter la compatibilité avec MySQL 8.4 LTS
...
* _AC-12014_ : marquer le module elasticsearch 8 comme obsolète
...
* _AC-12267_ : prend en charge les reprises de connexion pour la session Redis et compatible avec colinmollenhour/php-redis-session-abstract v2.0.0
   ...
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/commit/672a2e61>
* _AC-12268_ : Mise à niveau des dépendances du compositeur league/flysystem vers la dernière version.
   * _Remarque de correctif_ : mettez à niveau les dépendances du compositeur 2.x league/flysystem vers la dernière version 3.x
...
* _AC-12595_ : Ajouter la compatibilité avec MariaDB 11.4 LTS For EE
   * _Note de correction_ : ajout de la prise en charge de MariaDB 11.4 avec Adobe Commerce et les extensions
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/commit/b34c0a75>
* _AC-12693_ : Étude de l’outil de migration de données (DMT) avec MySQL 8.4 LTS
...
garantir la compatibilité et la mise à jour des fonctionnalités. Auparavant, la mise à jour vers les dernières versions de ces dépendances pouvait entraîner des problèmes d’incompatibilité descendante et des échecs de test.
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/commit/b34c0a75>
* _AC-12752_ : Ajouter la compatibilité avec l’outil MariaDB 11.4 LTS For Data Migration
   * _Note de correction_ : ajout de la prise en charge de MariaDB 11.4 avec Adobe Commerce et les extensions
...
* _AC-12898_ : compatibilité des outils UCT avec MySQL 8.4
   * _Remarque de correction_ : l’outil de compatibilité de mise à niveau (UCT) est désormais compatible avec MySQL 8.4, ce qui garantit le bon fonctionnement et les contrôles de compatibilité pour les instances s’exécutant sur cette version. Auparavant, l’outil UCT n’était pas testé et sa compatibilité avec MySQL 8.4 n’était pas vérifiée.
...
* _AC-6819_ : définissez les indexeurs sur « Mettre à jour selon le calendrier » par défaut
...
* _AC-12870_ : Compatibilité des outils SVC et EAT avec MariaDB 11.4
   * _Note de correction_ : compatibilité des outils SVC et EAT avec MariaDB 11.4
* _AC-12876_ : Compatibilité des outils UCT avec MariaDB 11.4
* _LYNX-374_ : confirmation de l’e-mail du document via GraphQL
* _LYNX-376_ : documentation sur l’obtention de configurations pour reCAPTCHA dans GraphQL
* _LYNX-409_ : optimisations des requêtes de base de données pour la mutation des éléments de panier de mise à jour

### Sécurité

* _AC-11041_ : améliorations de la sécurité pour la version 2.4.8-bêta1 à partir de juin 2024
* _AC-11864_ : améliorations de la sécurité pour la version 2.4.8-bêta1 à partir de la version d’août 2024
...
Nous avons corrigé 253 problèmes dans le code principal de Magento Open Source 2.4.8. Un sous-ensemble des problèmes résolus inclus dans cette version est décrit ci-dessous.
