...
---
# Adobe Commerce a résolu les problèmes (v2.4.8-beta2)
...
* _AC-13816_ : impossible d’activer la fonctionnalité b2b dans l’administrateur principal pour la première fois
...
* _AC-13817_ : impossible d’afficher les produits du panier lorsque toutes les fonctionnalités b2b sont activées
...
* _AC-13797_ : le lien d&#39;enregistrement du cadeau ne fonctionne pas correctement
...
* _AC-13596_ : la recherche avancée de catalogue avec des données vides accède à la page de résultats de recherche[branche 2.4.dev]
   ...
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/commit/6cfb9b6b>
* _AC-13786_ : la bordure blanche ne s’supprime pas après la désactivation de product_image_white_border pour le thème personnalisé
...
* _AC-13750_ : le total général et le total général de base ne correspondent pas aux étapes des résultats du test
