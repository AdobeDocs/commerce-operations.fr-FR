...
Nous avons corrigé 221 problèmes dans le code principal Magento Open Source 2.4.8. Vous trouverez ci-dessous un sous-ensemble des problèmes résolus inclus dans cette version.
...
* _AC-9922_ : Erreur CSP Google Analytics https://region1.analytics.google.com
   * _Remarque : le système autorise désormais correctement les connexions à &quot;https://region1.analytics.google.com&#39;&quot; lorsque Google Analytics est activé, ce qui empêche les erreurs CSP (Content Security Policy, stratégie de sécurité du contenu)._ Auparavant, l’activation des Google Analytics et l’affichage du site web à partir de l’UE entraînaient des erreurs de console CSP en raison d’un refus de connexion à &quot;https://region1.analytics.google.com&#39;&quot;.
...
* _AC-9712_ : Différence en moins de compilation entre la bibliothèque php et nodejs (grunt) avec des expressions `calc` compliquées
   * _Remarque : correction_ : correction de la différence de compilation entre la bibliothèque php et nodejs (grunt)
...
* _AC-8358_ : [Problème] Supprimer la balise `@author` interdite
   * _Remarque de correctif_ : le système respecte désormais les normes de codage en supprimant la balise `@author` interdite de certains modules, ce qui améliore la qualité et la cohérence du code. Auparavant, la présence de cette balise dans certains modules violait les normes de codage établies.
   * _Problème GitHub_ : <https://github.com/magento/magento2/issues/37264>
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/pull/37014>
* _AC-8360_ : [Problème] Supprimer la balise `@author` interdite
   * _Remarque de correctif_ : le système respecte désormais les normes de codage en supprimant la balise `@author` interdite de certains modules, ce qui améliore la qualité générale du code. Auparavant, la présence de cette balise dans certains modules violait les normes de codage établies.
   * _Problème GitHub_ : <https://github.com/magento/magento2/issues/37261>
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/pull/37011>
* _AC-8361_ : [Problème] Supprimer la balise `@author` interdite
   * _Remarque de correctif_ : le système respecte désormais les normes de codage en supprimant la balise `@author` interdite de certains modules, en assurant un code plus propre et plus normalisé. Auparavant, la présence de cette balise dans certains modules violait les normes de codage établies.
   * _Problème GitHub_ : <https://github.com/magento/magento2/issues/37260>
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/pull/37010>
* _AC-8400_ : [Problème] Supprimer la balise `@author` interdite
   * _Remarque de correctif_ : le système respecte désormais les normes de codage en supprimant la balise `@author` interdite de certains modules, ce qui améliore la qualité générale du code. Auparavant, la présence de cette balise dans certains modules violait les normes de codage établies.
   * _Problème GitHub_ : <https://github.com/magento/magento2/issues/37254>
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/pull/37004>
...
* _AC-8714_ : vernis 7.3 - Les liens/options des sous-catégories de la catégorie par défaut ne s’affichent pas sur la page d’accueil de l’interface de magasin
   * _Remarque : les pages d’accueil de Storefront affichent désormais les sous-catégories de catégorie par défaut comme prévu._ Auparavant, les acheteurs ne pouvaient accéder aux sous-catégories que par URL.
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/commit/d1c335aa>, &lt;https://github.com/magento/magento2/ (interne, non fusionné)>
...
* _ACP2E-3002_ : [CLOUD] Impossible de désactiver l’envoi d’emails à partir de l’interface utilisateur d’administration comme le montrent les documents de développement
   ...
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/commit/c8931218>
* _AC-12462_ : impossible de modifier l’état personnalisé intermédiaire dans l’administration à l’aide de l’ajout d’un formulaire de commentaire
   * _Remarque : le système met désormais correctement à jour l’état de la commande sur &quot;Prêt pour la récupération&quot; une fois modifié du formulaire &quot;Ajouter un commentaire&quot; dans le panneau d’administration, ce qui permet d’assurer un suivi précis de la progression de la commande._ Auparavant, l’état de la commande restait &quot;Envoyé&quot; même après avoir tenté de la modifier en &quot;Prêt pour la récupération&quot; via le formulaire &quot;Ajouter un commentaire&quot;.
   * _Problème GitHub_ : <https://github.com/magento/magento2/issues/38917>
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/pull/38923>
...
* _AC-12128_ : [Cloud] Vulnérabilité de sécurité Prototype.js CVE-2020-27511
   * _Remarque de correctif_ : La vulnérabilité de sécurité CVE-2020-27511 doit être résolue
   * _Contribution du code GitHub_ : <https://github.com/magento/magento2/commit/de4dfb8e>
