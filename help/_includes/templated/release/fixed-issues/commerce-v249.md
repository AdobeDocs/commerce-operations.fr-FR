...
#### Les informations sur le jeu d’attributs sont mises en cache (cache EAV), mais pas nettoyées après la mise à jour du jeu d’attributs dans la zone d’administration

Correction des valeurs d’attribut de produit manquantes après l’ajout de nouveaux attributs à un jeu d’attributs lorsque le cache EAV est activé (invalidation du cache/comportement d’importation de l’API).

_AC-12321 - [Problème GitHub](https://github.com/magento/magento2/issues/38827) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/38864)_
...
#### La galerie de médias GraphQl renvoie les entrées désactivées.

Correction du problème d’obtention des images de la galerie de médias qui ne sont pas désactivées pour un produit dans la réponse à la requête GraphQL.

_AC-1608 - [Problème GitHub](https://github.com/magento/magento2/issues/34342) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/34897)_
...
Auparavant, l’envoi de corps de requête ou de paramètres incorrects à divers points d’entrée de l’API REST (tels que /V1/carts/search, /V1/orders, /V1/products, etc.) générait une « erreur de serveur interne » (500), ce qui rendait difficile le diagnostic des problèmes d’entrée.
...
Les API REST V1/guest-carts/&lt;cartId>/items/ et V1/carts/mine/items/ valident désormais « product_options.extension_attributes.custom_options.*.option_id » pour s’assurer qu’elles font référence à un option_id valide pour le SKU de l’élément du panier. Auparavant, ce paramètre était traité et enregistré dans la base de données sans validation.
...
#### La file d’attente [CLOUD] n’est pas effacée

Amélioration de la résilience des consommateurs AMQP en bloquant les tentatives de retour/rejet non valides sur les canaux reconnectés.

_ACP2E-4621 - [contribution du code GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### La validation téléphonique des adresses client ne fonctionne pas lorsqu’il n’y a pas de caractères autorisés

Le système renvoie un message d&#39;erreur indiquant que le téléphone n&#39;est pas valide.

_AC-16227 - [Problème GitHub](https://github.com/magento/magento2/issues/40361) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40416)_

#### Les objets Website et Store renvoient des ID sous forme de chaînes

Correction d’un problème en raison duquel les identifiants de site web et de magasin étaient renvoyés sous forme de chaînes plutôt que de nombres entiers. Cela résout les erreurs de type en mode strict, ce qui permet à EmailNotification::newAccount() et aux méthodes similaires de fonctionner correctement.

_AC-16486 - [Problème GitHub](https://github.com/magento/magento2/issues/40469)_

#### La validation de la ville du client ne fonctionne pas pour les caractères non autorisés

Correction d’un problème où les adresses des clients pouvaient être enregistrées avec des caractères non valides (tels que /, @, #, !) dans le champ ville . Après ce correctif, le système valide et rejette correctement les adresses contenant des caractères interdits.

_AC-16504 - [Problème GitHub](https://github.com/magento/magento2/issues/40521) - [Contribution du code GitHub](https://github.com/magento/magento2/commit/57bad413)_

#### [Problème] Correction : augmentez la longueur des colonnes IP pour la prise en charge d’IPv6 dans admin_user_session

Actuellement, la colonne ip dans admin_user_session est limitée à 15 caractères, ce qui est insuffisant pour les adresses IPv6 (jusqu’à 45 caractères). Ce PR augmente la longueur à 45 pour assurer une compatibilité IPv6 complète et empêcher la troncature ou les erreurs de données lorsque l&#39;IPv6 est utilisé.

_AC-16659 - [Problème GitHub](https://github.com/magento/magento2/issues/40570) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40563)_
...
#### La validation du nom de ville accepte les caractères interdits (!« #?)

Lors de la saisie d’une ville dans une adresse de client, la validation autorise désormais une barre oblique et rejette correctement les caractères non valides tels que !,  », # et ?.

_ACP2E-4527 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

#### Validateurs d’adresses rompant un client existant après la mise à niveau vers la version 2.4.8-p3

Auparavant, avant ce correctif, les numéros de téléphone modernes avec les caractères . ou \ n’ont pas été validés correctement. Après l’application de ce correctif, les numéros de téléphone modernes avec les caractères . ou \ sont maintenant validés.

_ACP2E-4554 - [contribution du code GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Cloud] PHPSESSID modifié après la demande de réinitialisation du mot de passe et l’effacement du panier actuel

Avant le correctif, l’envoi du formulaire de mot de passe oublié entraînait la destruction/la régénération de la session (changement de PHPSESSID) et l’effacement du panier d’invités. Après le correctif, l’envoi du formulaire de mot de passe oublié laisse la session inchangée et le panier d’invités est conservé.

_ACP2E-4524 - [contribution du code GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Problème] Correction (administration) : position correcte du sélecteur de date dans la diapositive modale

Cette demande d’extraction corrige un problème en raison duquel le sélecteur de date Magento ne s’affiche pas correctement dans les boîtes de dialogue modales d’administration.
Par exemple, cela affectait la section Tarification avancée lors de la modification ou de la création d’un produit à partir du panneau d’administration.

_AC-16378 - [Problème GitHub](https://github.com/magento/magento2/issues/40468) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40225)_

#### Les valeurs FPT dans la page de panier et la page de produit sont différentes pour les mêmes configurations

Correction d’un problème où les valeurs de taxe sur les produits fixes (FPT) s’affichaient différemment sur les pages de produits et de panier en raison d’incohérences d’arrondi. Après ce correctif, les prix FPT sont désormais cohérents sur les pages de catalogue, de produits et de panier, ce qui élimine les incohérences.

_AC-16550 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/8391dbcc)_
...
Les couleurs de survol sont désormais appliquées comme prévu sur les lignes des grilles statiques Admin.[GitHub-35358](https://github.com/magento/magento2/issues/35358)
...
_ACP2E-4337 - [contribution du code GitHub](https://github.com/magento/magento2/commit/31258bf6)_
...
#### Impossible de mettre à jour la configuration du magasin dans le panneau d’administration

Auparavant, le cache local, le cache obsolète et Redis pouvaient être désynchronisés lorsque Redis n’était pas disponible. Les modifications de configuration effectuées lors des pannes Redis n’étaient pas correctement répercutées après la récupération de Redis, ce qui entraîne la persistance de valeurs obsolètes. Ce correctif garantit une synchronisation correcte sur tous les caches afin que les dernières valeurs enregistrées soient conservées et visibles même lorsque Redis est hors service.

_ACP2E-4447 - [contribution du code GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### La grille d’archivage ne se synchronise pas avec les dernières données de commande lorsque l’indexation asynchrone de la grille est activée

La grille d’archivage des commandes client affiche désormais le statut correct de la commande avec une indexation asynchrone

_ACP2E-4493 - [contribution du code GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

#### Attribut de produit Modifications en masse du type de produit Virtual->Simple

Empêche le message « Est-ce que cela a un poids ? » les commandes de l’activation avant l’insertion des panneaux d’attributs de mise à jour en masse, évitant les changements de poids involontaires pour les produits virtuels.

_ACP2E-4500 - [contribution du code GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### Le texte des PDF de factures de plusieurs pages se chevauche lorsque le nom du produit et les options personnalisées sont longs

Avant la correction, dans les PDF de factures, d’expéditions, d’avoirs et de retours comportant plusieurs pages, les noms de produits longs avec des options personnalisées pouvaient se chevaucher avec des colonnes/éléments adjacents après les sauts de page, ce qui rendait les sections d’élément de ligne illisibles.
Après la correction, les éléments de ligne se propagent désormais correctement sur les pages, et les noms/options longs s’affichent sans chevauchement dans les PDF de facture, d’expédition, d’avoir et de retour.

_ACP2E-4630 - [contribution du code GitHub](https://github.com/magento/magento2/commit/d8a248cd)_

#### L’éditeur [Cloud] HugeRTE bloque les émoticônes après la mise à niveau

Avant le correctif, la validation de WYSIWYG/PageBuilder bloquait inconditionnellement le contenu moderne des émoticônes à 4 octets en raison d’une règle d’interface utilisateur appliquée trop largement, même sur les installations où le chemin de stockage réel était compatible avec utf8mb4. Après le correctif, la validation est décidée en fonction du chemin de persistance réel en vérifiant le jeu de caractères/classement de la connexion à la base de données actif avec le classement de la colonne de contenu cible, de sorte que le contenu sécurisé par utf8mb4 est autorisé tandis que les chemins utf8/utf8mb3 restent protégés.

_ACP2E-4675 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/c58a8ad0) - [Contribution du code GitHub](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_

#### [Cloud] Les chemins d’accès aux images sont absolus lors de la deuxième modification dans Pagebuilder

Correction d’un problème en raison duquel la modification en ligne de texte de Page Builder pouvait enregistrer des URL d’images de médias absolus après la modification d’une image, au lieu de conserver la directive de `{{media url=...}}` portable.

_ACP2E-4698 - [contribution du code GitHub](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_
...
### Interface utilisateur d’administration, catalogue, performances

#### Mauvaise performance de l’appel gettree dans la galerie de médias

Amélioration des performances de Media Gallery en passant du chargement d’arborescence de répertoire à l’extension de nœud à la demande au lieu de créer l’arborescence complète en amont, ce qui réduit considérablement le temps de réponse gettree initial sur les structures de répertoire multimédia volumineuses

_ACP2E-4605 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
### Interface utilisateur d’administration, client/clients

#### Le bouton de réinitialisation du formulaire de l’interface utilisateur ne fonctionne pas comme prévu pour le champ « Associer à l’entreprise » dans la page d’ajout et de modification du client

Correction d’un problème en raison duquel le bouton de réinitialisation ne réinitialisait pas correctement le champ « Associer à l’entreprise » dans le formulaire d’ajout/de modification du client. Le formulaire réinitialise désormais correctement tous les champs sans rechargement de page, ce qui permet de restaurer le comportement attendu.

_AC-16364_

### Interface utilisateur d’administration, importation/exportation

#### L’exportation du fichier CSV peut être téléchargée tant que l’exportation n’est pas terminée

Avant le correctif, les fichiers d’exportation de produits en file d’attente étaient écrits directement à leur emplacement final dans var/export, de sorte que la grille d’exportation d’administration puisse les afficher et permettre le téléchargement avant la fin de la génération. Par conséquent, les utilisateurs pouvaient télécharger des fichiers CSV vides ou partiellement générés, et les fichiers non liés présents dans var/export pouvaient également apparaître dans la liste d’exportation et être téléchargeables.
Après le correctif, les exportations en file d’attente sont écrites dans un fichier temporaire et publiées à l’emplacement d’exportation final uniquement une fois la génération terminée avec succès. La grille d’exportation d’administration et l’action de téléchargement n’exposent désormais que les fichiers d’exportation terminés dont le format correspond aux options de format de fichier d’exportation configurées, empêchant les téléchargements partiels et excluant les fichiers non liés de l’interface utilisateur.

_ACP2E-4724 - [contribution du code GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
### Interface utilisateur d’administration, commande, paiements

#### Impossible de traiter le remboursement partiel - erreur de calcul du remboursement

Le remboursement des commandes en ligne fonctionne désormais correctement. Auparavant, il renvoyait l’erreur suivante : « La passerelle PayPal rejette la demande. Erreur interne ».

_ACP2E-4615 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_

### Interface utilisateur d’administration, Performances

#### Lenteur importante du panneau d’administration d’évaluation lors de l’enregistrement du produit

L’enregistrement/modification des formulaires de produit par l’administrateur est plus rapide pour les jeux d’attributs volumineux car il réduit les passes de validation côté client coûteuses tout en préservant le comportement de validation existant. Cela réduit le risque de blocages de « page ne répondant pas » dans l’interface utilisateur d’administration.

_ACP2E-4488 - [contribution du code GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

### Interface utilisateur d’administration, produit

#### [Cloud] RequireJS mixins.js entraîne le chargement de script en double pour tous les modules deps.

Avant le correctif, certains fichiers JavaScript de storefront pouvaient être demandés et exécutés deux fois, provoquant des chargements en double intermittents et un comportement instable. Après le correctif, les dépendances de JavaScript ne sont chargées qu’une seule fois, ce qui élimine les demandes en double tout en préservant les fonctionnalités de mixin existantes.

_ACP2E-4626 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Problème de gestion des entrées dans le champ Date d’expiration du compte de carte cadeau

Lors de la création ou de la modification d’un compte de carte cadeau dans Admin, le champ Date d’expiration est désormais validé de manière appropriée. Auparavant, les valeurs saisies manuellement qui ne correspondaient pas à un format de date valide pouvaient être traitées de manière incorrecte lors de l’enregistrement du compte.
...
#### [Problème] Correctif de performances pour la tâche cron analytics_collect_data sur le long terme

Optimisation des performances des tâches cron analytics_collect_data pour les bases de données volumineuses en mettant à jour les requêtes de validation des rapports afin d’utiliser LIMIT 1 au lieu de LIMIT 0. Cela évite le chargement inutile des données de table complète pendant la validation et réduit considérablement le temps d’exécution. Aucun impact fonctionnel, amélioration entièrement rétrocompatible.

_AC-16639 - [Problème GitHub](https://github.com/magento/magento2/issues/40590) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40463)_

#### Le rapport de l’utilisateur du journal des actions d’administration n’affiche pas les détails du filtre utilisé lors de l’application des filtres
...
#### Pic d’E/S de disque maximal sur les nœuds de service en raison du traitement Cron aggregate_sales_report_order_data.

Correction du problème en raison duquel la génération du rapport de commandes agrégées quotidiennes prenait trop de temps pour un grand volume de commandes, provoquant des pics d’E/S de disque et une dégradation des performances. Après la correction, le rapport est généré en temps voulu.

_ACP2E-4363 - [contribution du code GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### [CLOUD] Dégradation des performances en raison de l’exécution de la commande cron analytics_collect_data

Améliorez les performances liées à la tâche cron Analytics.

_ACP2E-4496 - [contribution du code GitHub](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### Passer en caisse et demander un devis non visible sur le panier après l’affectation du client à l’entreprise lors de la connexion

Correction d’un problème en raison duquel, lorsqu’un client est affecté à une entreprise alors qu’il est connecté au storefront, les boutons « Passer en caisse » et « Demander un devis » n’étaient pas visibles sur la page du panier. Après ce correctif, les deux boutons s’affichent immédiatement sans que le client ait à se déconnecter ni à se reconnecter.
...
#### [B2B] la page Mes devis n’affiche aucun devis lorsque certains devis contiennent des produits supprimés

Mon devis affiche désormais correctement les devis lorsque certains devis contiennent des produits supprimés.

_ACP2E-4608 - [contribution du code GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Les coupons multiples ne fonctionnent pas comme prévu pour Google Pay

Correction d’un problème en raison duquel plusieurs codes de coupon ne fonctionnaient pas comme prévu dans la feuille de paie Google Pay Express. Auparavant, l’application d’un deuxième code de coupon supprimait incorrectement la remise du premier coupon et affichait des totaux inexacts. La suppression des coupons n&#39;a pas non plus correctement mis à jour la feuille de paie.
Les clients peuvent maintenant appliquer plusieurs codes de coupon dans la feuille de paie Google Pay Express, et toutes les remises sont reflétées avec précision.

_LOT-3507_

#### Braintree SDK reçoit un appel sur chaque page pour obtenir le jeton client, même si le message Pay Later est désactivé

Le SDK Braintree effectuait un appel pour récupérer le jeton client à chaque chargement de page, même lorsque le message Payer plus tard était désactivé. Cela entraînait des requêtes inutiles et des problèmes de performances potentiels.
Le système ne demande désormais le jeton client Braintree que si le mode de paiement PayPal et le message Pay Later pour le panier sont activés. Cela évite les requêtes de jeton inutiles et améliore les performances de chargement de page.

_LOT-3508_

#### Arrêtez le rendu du modèle de coffre-fort et des fichiers js des modes de paiement Braintree dans la section « Modes de paiement stockés » de la zone du compte client

Les fichiers JavaScript et de modèle pour les modes de paiement Braintree étaient rendus dans la section « Modes de paiement stockés » de la zone du compte client, même lorsque les modes de paiement Braintree et les configurations de chambre forte étaient désactivés. Cela provoquait des erreurs inutiles dans la console du navigateur.
Le système vérifie désormais si le mode de paiement Braintree et sa configuration de chambre forte sont activés avant d’effectuer le rendu des fichiers et formulaires associés. Ce n&#39;est que lorsque les deux sont activés que les modèles et scripts de coffre-fort apparaissent dans la section « Modes de paiement stockés ».

_LOT-3509_

#### Problèmes de compatibilité des tiers avec Apple Pay et Google Pay

Les clients ont rencontré des erreurs lors de l’exécution de paiements via Apple Pay ou Google Pay à l’aide d’extensions de passage en caisse tierces (telles que Hyvä Checkout) ou de personnalisations. Plus précisément, Apple Pay générerait une erreur TypeError en raison d’un nom de vendeur manquant, et Google Pay pourrait également échouer en fonction des interactions de code personnalisé.
Les problèmes de compatibilité avec Apple Pay et Google Pay ont été résolus. Le système gère désormais correctement les extensions et personnalisations de passage en caisse tierces, tout en s’assurant que les valeurs de configuration requises sont présentes et correctement renvoyées.

_LOT-3510_

#### Google Pay via Braintree entraîne un chargement infini lors du passage en caisse

Lorsque Google Pay était activé via Braintree, le processus de passage en caisse entrait dans un état de chargement infini après avoir sélectionné Google Pay comme mode de paiement. Cela empêchait les clients d&#39;exécuter leurs commandes, sans message d&#39;erreur ni retour d&#39;informations.
L’intégration de Google Pay via Braintree a été corrigée afin de s’assurer que le flux de paiement se déroule comme prévu. Les clients peuvent désormais sélectionner Google Pay lors du passage en caisse, terminer le processus de paiement et passer des commandes avec succès.
...
#### Le sous-total indique 0 après l’extraction avec plusieurs adresses et l’ajout d’une option différente du produit configurable

Correction d’un problème en raison duquel le sous-total du panier s’affichait incorrectement en tant que 0 après l’ajout d’une autre option d’un produit configurable après la passage en caisse multi-adresses. Le sous-total reflète désormais correctement la valeur réelle du panier.

_AC-14460 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/57bad413)_
...
#### [Problème] appeler RemoveItem sur le panier au lieu de ItemRepository

Remplace les appels deleteById sur CartItemRepository par removeItem sur l’instance de panier.
Cela permet de s’assurer que les observateurs attendus sont déclenchés et que l’élément est également mis à jour dans l’objet de panier, plutôt que dans la base de données uniquement.

_AC-15963 - [Problème GitHub](https://github.com/magento/magento2/issues/40255) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40248)_
...
#### La remise de règle de prix du panier ne fonctionne pas avec la condition de SKU exclue.

Correction d’un problème en raison duquel les règles de prix de panier étaient incorrectement appliquées même lorsque des SKU exclues étaient présentes dans le calcul du sous-total. La logique de remise ignore désormais correctement les éléments exclus lors de l’évaluation des conditions de règle.

_AC-16417 - [Problème GitHub](https://github.com/magento/magento2/issues/40503) - [Contribution du code GitHub](https://github.com/magento/magento2/commit/8391dbcc)_
...
Avant la correction lors de l&#39;annulation de l&#39;option multishipping, l&#39;adresse n&#39;était pas présélectionnée lors du retour à la multishipping. Désormais, l’adresse par défaut est remplacée par l’une des sélections effectuées dans l’écran d’expédition multiple.
...
#### qté affichée comme 0 dans la section de panier client administrateur lors de l’ajout de produits BUNDLE  
...
_ACP2E-4245 - [contribution du code GitHub](https://github.com/magento/magento2/commit/cbca0396)_
...
#### [CLOUD] problème lors de l’application d’une carte cadeau avec Recaptcha v2 (« Je ne suis pas un robot »)

Les cartes-cadeaux sont désormais correctement appliquées lorsque reCAPTCHA v2 (« Je ne suis pas un robot ») est activé, après validation réussie de reCAPTCHA.

_ACP2E-4410_

#### Un devis nul est créé lors de l’utilisation de la fonction Connexion en tant que client à partir de l’administrateur

Correction d’un problème en raison duquel un devis nul était créé pendant le flux « Connexion en tant que client ».

_ACP2E-4472 - [contribution du code GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### Incohérence dans le comportement des produits groupés avec l’expédition à taux forfaitaire et l’expédition gratuite

Avant la correction, la livraison gratuite n’était pas correctement calculée pour les produits groupés lorsqu’ils étaient fournis via des règles de remise sur le panier. Après le correctif, la livraison gratuite est correctement calculée pour les produits groupés.

_ACP2E-4536 - [contribution du code GitHub](https://github.com/magento/magento2/commit/c12a7510)_

#### La commande ne peut pas être passée pour des produits avec des SKU numériques

Le système ne renvoie plus d’erreur lors de la commande d’un produit avec un SKU numérique.

_ACP2E-4669 - [contribution du code GitHub](https://github.com/magento/inventory/commit/83d11138)_

#### Les règles de validation Attribut de l’adresse du client (EAV) entrent en conflit avec les règles de validation codées en dur.

Amélioration de la validation téléphonique des adresses client pour la prise en charge des valeurs allant jusqu’à 255 caractères, l’alignement des contrôles côté serveur avec les limites de la base de données. La gestion des erreurs a également été affinée afin que les numéros de téléphone trop longs renvoient un message clair spécifique à la longueur.

_ACP2E-4735 - [contribution du code GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### [Coupon] Erreur de saisie de coupon en double intermittent dans la table quote_coupons

Correction d’une erreur de clé en double intermittente sur la table quote_coupons lorsque plusieurs demandes de fusion de panier ou d’enregistrement de devis s’exécutaient simultanément.
...
_ACP2E-4266 - [Contribution du code GitHub](https://github.com/magento/inventory/commit/ae1f272f)_
...
### Panier et passer en caisse, performance

#### [TOYOTA] Problème de performance avec la classe Magento\Store\Model\System\Store

Amélioration des performances liées à plusieurs magasins et sites web.

_ACP2E-4491 - [contribution du code GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

### Panier et passer en caisse, prix, taxe

#### Les prix des produits groupés affichent des valeurs de taxe et de devise incorrectes entre le PDP et le panier dans une configuration multidevise.

Les prix des produits groupés s’affichent désormais correctement entre les pages PDP et Passage en caisse.

_ACP2E-4673 - [contribution du code GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### Le widget Liste de produits du catalogue Magento renvoie un nombre incorrect

Le widget Liste de produits du catalogue Adobe Commerce renvoie désormais le nombre total correct et la pagination (par exemple, 9 éléments sur les pages telles que configurées).

_AC-14541 - [Problème GitHub](https://github.com/magento/magento2/issues/39863) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40421)_
...
#### génération automatique des balises Meta : les variables ne peuvent pas être utilisées plusieurs fois

La génération automatique de mots-clés de métadonnées de produit remplace désormais tous les espaces réservés dans le masque configuré (par exemple, `{{name}}, order {{name}}`), et pas seulement la première occurrence.

_AC-14626 - [Problème GitHub](https://github.com/magento/magento2/issues/35670) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40412)_
...
#### L’ID de groupe client de la société n’est pas affecté à l’ID de groupe client de l’administrateur de la société lorsque l’administrateur de la société est modifié

Lors du changement d’administrateur d’une société dans le B2B, l’ID de groupe client du nouvel administrateur de la société n’a pas été mis à jour pour correspondre au catalogue partagé affecté à la société. Les prix de niveau et les autorisations de catégorie pour le nouvel administrateur étaient alors basés sur le groupe de clients de la société précédente, ce qui entraînait des prix et des autorisations incorrects.
Le système met désormais correctement à jour l’ID de groupe de clients de l’administrateur de la société lorsque l’administrateur est modifié. Cela permet de s’assurer que le nouvel administrateur reçoit les prix de niveau et les autorisations de catégorie appropriés associés au catalogue partagé de son entreprise.

_AC-14897 - [Problème GitHub](https://github.com/magento/magento2/issues/39964)_
...
#### Site web de l’alerte du stock de produits et problème de correspondance de stock pour plusieurs sites web

Ce correctif inclut website_id et store_id des tables product_alert_stock et product_alert_price dans la clause SELECT de collection, en veillant à ce que la grille d’administration affiche le site web correct auquel chaque alerte a été abonnée.

_AC-15044 - [Problème GitHub](https://github.com/magento/magento2/issues/40027) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40431)_
...
#### [Problème] Correction d’une erreur lors de la visite de la page de comparaison sans éléments

Correction d’un bug en raison duquel la visite de la page de comparaison de produits du catalogue sans comparaison d’éléments provoquait une erreur fatale en s’assurant que l’action de comparaison traitait de manière sécurisée les collections d’éléments vides au lieu de générer des exceptions.

_AC-15746 - [Problème GitHub](https://github.com/magento/magento2/issues/40205) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40203)_
...
#### L’e-mail de récupération en magasin utilise toujours des méthodes héritées

Aucune description disponible.

_AC-16380 - [Problème GitHub](https://github.com/magento/inventory/issues/3384) - [Contribution du code GitHub](https://github.com/magento/inventory/pull/3385) - [Contribution du code GitHub](https://github.com/magento/inventory/commit/b4aeda50)_
...
Correction d’un problème où les options de liste déroulante supprimées étaient toujours conservées lors de la création d’attributs de produit. Le système supprime désormais correctement les options sélectionnées et reflète le nombre exact après l’enregistrement.

_AC-16437 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/57bad413)_
...
#### [CLOUD] Comparer les produits Incompatibilité de nombre Problème pour différents magasins
...
#### [CLOUD] Dépendance de catégorie circulaire

Avant la correction, vous pouviez enregistrer des catégories avec une dépendance circulaire. Après le correctif, ce comportement est empêché par une règle de validation.

_ACP2E-4505 - [contribution du code GitHub](https://github.com/magento/magento2/commit/f2fd9628)_

#### La hiérarchie CMS ne met pas à jour l’URL hiérarchique lorsque la clé de l’URL de la page enfant est modifiée (2.4.8-p3)
...
#### L’espace réservé de l’image ne s’affiche pas comme prévu pour différents magasins

Avant la correction, les images d’espace réservé n’étaient pas chargées dans le code de magasin lorsque celui-ci était inséré dans l’URL. Après le correctif, les espaces réservés d’image sont sensibles à la portée avec ou sans code de magasin fourni dans l’URL.

_ACP2E-4533 - [contribution du code GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_

#### [CLOUD] blocage sur la table magento_catalogpermissions_index_product. continuation

Avant le correctif, l’exécution de la réindexation des produits des autorisations du catalogue pouvait laisser inchangées les lignes d’index d’autorisations existantes. Par conséquent, les autorisations de catégorie mises à jour n’étaient pas répercutées de manière fiable sur les produits.
Après le correctif, la réindexation met correctement à jour les lignes d’index d’autorisation existantes, de sorte que les modifications d’autorisation soient appliquées de manière cohérente dans l’accès au storefront, la visibilité des prix et la disponibilité du passage en caisse.

_ACP2E-4603_

#### L’indexeur de règle cible cron ne sélectionne pas les produits activés uniquement à la portée d’affichage du magasin

Avant le correctif, les produits qui n’étaient pas activés dans la portée d’administration n’étaient pas sélectionnés par l’indexeur de règles cible. Désormais, après la correction, les produits sont sélectionnés s’ils sont activés dans au moins une portée.
...
#### [Cloud] - Une erreur s’affiche lorsque la valeur catalog_product_entity_int pour attribute_type sélectionne 0 ou Null dans les produits graphql

Correction d’un problème en raison duquel la requête de produits GraphQL avec des agrégations renvoyait une erreur avec des valeurs d’attribut ou des options non valides. La requête gère désormais correctement les données non valides et renvoie des résultats corrects.

_ACP2E-4529 - [contribution du code GitHub](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### La structure du dossier Galerie de médias disparaît lorsque le nom de l’image de la catégorie commence par « - » (tiret)

Aucune description disponible.

_AC-16544 - [Problème GitHub](https://github.com/magento/magento2/issues/40536)_

#### L’erreur « Le bloc CMS contient un contenu non valide » s’affiche lors de l’enregistrement du bloc CMS « Énumérateur d’événements de catalogue »

Correction d’un problème en raison duquel l’enregistrement du bloc CMS par défaut « Énumérateur d’événements de catalogue » affichait l’erreur « Le bloc CMS contient un contenu non valide ». Après ce correctif, le bloc peut être enregistré sans erreur dans le panneau d’administration.

_AC-16686 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/0c9a749b)_
...
#### [ADOBE STOCK ] Journaux critiques sur « Échec de récupération des résultats des fichiers de recherche Adobe Stock » même lorsque l’intégration est désactivée.

Le système ne consigne plus l’erreur « Échec de la récupération des résultats des fichiers de recherche Adobe Stock » lorsque l’intégration Adobe Stock est désactivée.

_ACP2E-4634_

#### Erreurs lors de la création de pages et de l’utilisation de Page Builder

Correction d’un problème en raison duquel les pages CMS n’étaient pas enregistrées lors de l’utilisation de Page Builder.
...
#### Échec de la réinitialisation du mot de passe `[Admin][Customer]` sur Customer Admin

Correction d’un problème en raison duquel la réinitialisation du mot de passe d’un client à partir du panneau d’administration provoquait une erreur système et un blocage de la page. La réinitialisation du mot de passe fonctionne désormais correctement et envoie le lien de réinitialisation sans erreur, même dans les cas Edge impliquant des modifications de magasin.

_AC-14940 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/3e41a43b)_
...
_AC-14883 - [Problème GitHub](https://github.com/magento/magento2/issues/39947) - [Contribution du code GitHub](https://github.com/magento/magento2/commit/3717e6cb) - [Contribution du code GitHub](https://github.com/magento/magento2/commit/d3ea191d)_
...
_AC-15446 - [Problème GitHub](https://github.com/magento/magento2/issues/40170) - [Contribution du code GitHub](https://github.com/magento/magento2/commit/e9412b24)_
...
#### Module New Relic - Supprimer les dépendances inutiles

Supprime la dépendance inutile magento/magento-composer-installer du module de rapport magento/module-new-relic pour nettoyer les couplages inutilisés/serrés dans les dépendances

_AC-15945 - [Problème GitHub](https://github.com/magento/magento2/issues/40243)_
...
#### Cron captcha_delete_expired_images ne fonctionne pas après la mise à jour de Magento 2.4.8

Avant la correction, les images de captcha expirées n’étaient plus supprimées automatiquement. Après la correction, les images de captcha expirées sont supprimées par la tâche cron correspondante.

_ACP2E-4512 - [contribution du code GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

### Framework, Performance

#### [CLOUD] Requête de réconciliation MySQL lente dans le cron asynchrone de la grille de vente : analyse complète de la table, 20+ s, ~14 millions de lignes examinées

Amélioration des performances de réconciliation asynchrone des grilles de ventes en passant la découverte d’ID manquants aux fenêtres entity_id liées avec une progression basée sur le curseur, ce qui réduit les analyses répétées de grandes tables sur les magasins à volume élevé.

_ACP2E-4585 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### AC-2.4.9 - Impossible de rechercher les commandes sur la plaque chauffante EDS

Le type d&#39;entrée de requête de GraphQL guestOrder a été mis à jour vers GuestOrderInformationInput au lieu de OrderInformationInput.

_LYNX-872_

#### [AC-2.4.9] La requête Panier renvoie un statut de disponibilité incorrect pour les produits avec inventaire multi-Source (MSI) et le stock par défaut est 0

Correction d’un problème en raison duquel l’API du panier renvoyait incorrectement is_available : false pour les produits qui disposaient d’un inventaire suffisant pour plusieurs sources d’inventaire Source (MSI).

_LYNX-918_

#### [AC-2.4.9] ne peut pas définir l&#39;adresse d&#39;expédition/de facturation d&#39;un client avec les GQL setNegotiableQuoteShippingAddress/setNegotiableQuoteBillingAddress

Exposition du champ uid dans la requête GraphQL d’adresses client pour permettre de définir les adresses d’expédition et de facturation dans les devis négociables.

_LYNX-924_

#### [AC-2.4.9] Liste de commandes | erreur de serveur interne

Stabilité garantie des flux de commandes en renvoyant la valeur null pour les produits achetés manquants, en évitant les exceptions dans l’historique des commandes et les commandes récentes.

_LYNX-937_

#### [AC-2.4.9] Aligner l’entrée de l’adresse de facturation sur l’entrée de l’adresse de facturation

&#39;
AlignedQuoteBillingAddressInput, BillingAddressInput, ShippingAddressInput et GiftRegistryShippingAddressInput pour prendre en charge l’UID d’adresse client tout en rendant obsolète l’ID d’adresse client.
Ajout de mutations deleteCustomerAddressV2 et updateCustomerAddressV2 pour prendre en charge l’UID d’adresse du client et abandon des mutations deleteCustomerAddress et updateCustomerAddress existantes.
...
### GraphQL, Commande, Tarification

#### [Cloud] La requête customerOrders SalesGraphQl renvoie des valeurs incorrectes pour les champs d’élément de commande

Correction du problème en raison duquel la requête SalesGraphQl customerOrders renvoyait des valeurs original_price_include_tax et original_row_total_include_tax gonflées lorsque les prix du catalogue étaient définis sur « Taxe incluse », car la taxe était appliquée une seconde fois aux prix qui incluaient déjà la taxe.

_ACP2E-4762 - [contribution du code GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### Advanced Pricing CSV, Products CSV non exporté. OOM même avec la limite de mémoire 4G

Avant le correctif, les exportations complètes de produits et de prix avancés pouvaient échouer avec une utilisation de la mémoire/un OOM élevé sur les catalogues volumineux, et la pagination de l’exportation de produits pouvait produire des lignes en double lorsque la taille de page dynamique changeait pendant le traitement. Après la correction, les exportations se terminent avec un comportement stable de la mémoire à l’aide du traitement par lots paginés, les lignes en double du chevauchement de pagination sont éliminées et le contenu des lignes exportées reste aligné sur la sortie de base.

_ACP2E-4587 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Statut de vente groupée non mis à jour lorsque la commande est annulée

La vente du produit groupé est maintenant correctement calculée après l&#39;annulation de la commande.

_ACP2E-4481 - [contribution du code GitHub](https://github.com/magento/inventory/commit/96b77663)_

#### Magento permet la survente lorsque plusieurs clients passent des commandes simultanément

Avec MSI, plusieurs clients pouvaient passer des commandes pour le même produit en même temps et dépasser les stocks disponibles, ce qui entraînait des ventes excessives. Après le correctif, une seule commande peut réussir par produit lorsque les passages en caisse s’exécutent simultanément, de sorte que les ventes excessives ne se produisent plus.

_ACP2E-4509 - [contribution du code GitHub](https://github.com/magento/inventory/commit/a33c60f2)_

#### [CLOUD] Délais d’expiration si les clients ont plus de 140 articles dans le panier

Les requêtes de base de données d’inventaire ont été optimisées pour charger rapidement les données d’inventaire lors du passage en caisse. Cela élimine le besoin de requêtes individuelles pour chaque SKU, ce qui entraîne un gain de performances significatif pour le passage en caisse avec des paniers volumineux.

_ACP2E-4519 - [contribution du code GitHub](https://github.com/magento/inventory/commit/40858072)_

### Fidélité

#### [CLOUD] getCustomerRewardPoints renvoie une exception lorsque le client n’a aucun point

Les points de récompense client sont créés avec succès via l’administrateur.

_ACP2E-4403 - [contribution du code GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### La fonction AddComment de facture peut générer une erreur lorsque la fonction Invoice getComments est appelée en premier

Cette requête résout un bug critique en raison duquel l&#39;appel de $facture->getComments() avant $facture->addComment() provoquait une erreur irrécupérable « Appel à une fonction membre addItem() sur le tableau ». Le correctif implémente une vérification et une conversion de type appropriées entre les types tableau et Collection dans les méthodes de commentaire du modèle de facture, en s&#39;assurant que les deux méthodes peuvent être appelées dans n&#39;importe quel ordre sans erreur tout en maintenant une rétrocompatibilité.

_AC-14848 - [Problème GitHub](https://github.com/magento/magento2/issues/39884) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40428)_
...
#### La colonne « adresse d&#39;expédition » de la grille Commandes - Ventes est absente.

Correction d’un problème en raison duquel la colonne d’adresse de livraison de la grille Commandes d’administration n’affichait pas le pays pour les commandes internationales. L&#39;adresse comprend désormais des informations sur le pays, améliorant la visibilité et la convivialité des commandes.

_AC-16256 - [Problème GitHub](https://github.com/magento/magento2/issues/40403) - [Contribution du code GitHub](https://github.com/magento/magento2/commit/3e41a43b)_

#### Le client de commande asynchrone rejette les commandes avec mise à jour de stock différée : NoLikeEntityException dans CartManagementPlugin::getActive() (devis inactif)

Correction d’un problème critique en raison duquel le passage en caisse asynchrone avec mise à jour de stock différée échouait pour les commandes de clients. Auparavant, le client renvoyait une exception NoLikeEntityException en raison de guillemets inactifs, ce qui entraînait le marquage des commandes comme étant rejetées au lieu d&#39;être en attente. Après ce correctif, le client traite correctement les devis inactifs, déplace les commandes de Reçu vers En attente et ajuste les quantités vendables comme prévu. Le test MFTF AsyncOrderWithAsyncStockReservationTest est désormais réussi.

_AC-16680 - [Contribution du code GitHub](https://github.com/magento/inventory/commit/d3b2ef0b)_
...
#### GraphQL cancelOrder n’annule pas les commandes entièrement payées avec la carte cadeau

Avant la correction, une commande entièrement payée par carte cadeau n’était pas automatiquement considérée comme « clôturée » lors d’un appel via une mutation de GraphQL. Désormais, après la correction, la commande passe au statut fermé lors de son annulation via GraphQL.

_ACP2E-4455 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/e2b23caa)_

#### L’utilisation des coupons ne revient pas en cas d’annulation ou de rejet de la commande

Lorsque vous annulez une commande, l’utilisation du coupon appliqué est désormais correctement réinitialisée, même si la configuration du statut de la commande a été modifiée. Cela pouvait entraîner le marquage des coupons comme utilisés après l’annulation d’une commande lorsque les paramètres personnalisés du statut de la commande étaient en place.
...
#### Règles de prix du panier basées sur le retard des segments de clientèle pour les utilisateurs enregistrés

Correction d’un problème où les règles de prix de panier basées sur les segments de clients n’étaient pas appliquées immédiatement pour les utilisateurs enregistrés. La réduction s’applique désormais correctement lors de l’ajout d’un produit éligible au panier sans nécessiter d’actualisation du jeton.

_LYNX-814_

#### GQL - Le champ Quantité dans ProductInterface ne renvoie pas la quantité vendable

Résolution d&#39;un problème GraphQL en raison duquel le champ Quantité dans ProductInterface ne renvoyait pas la quantité vendable.

_LYNX-816_

#### Impossible de renvoyer la valeur null pour le champ « SelectedShippingMethod.carrier_code » non nullable

Correction d’un problème en raison duquel la sélection de la deuxième méthode d’expédition lors du passage en caisse avec une adresse aux États-Unis provoquait une erreur Impossible de renvoyer la valeur null pour le champ « SelectedShippingMethod.carrier_code » non nullable. Ce correctif garantit une navigation fluide vers l’extraction sans déclencher d’erreurs de serveur internes.

_LYNX-817_

#### [AC-2.4.9] addProductsToCartMutation renvoie 200 en cas d’erreur

Ajout d’un nouveau code d’erreur, REQUIRED_PARAMETER_MISSING, pour gérer les erreurs utilisateur lorsque les options de produit configurables ne sont pas sélectionnées lors de l’ajout au panier.

_LYNX-884_

#### [AC-2.4.9] Erreur lors de la demande du champ CartItem.not_available_message ou is_available lorsque la vérification de l’inventaire du panier est désactivée

Correction d’une erreur lors de l’accès à not_available_message ou is_available sur CartItem lorsque la vérification de l’inventaire du panier était désactivée.
...
#### Tâche cron bloquée en raison de OOM - demande de révision de innodb_buffer_pool_size et PHP memory_limit pour cron

Le traitement des transactions de paiement a été amélioré

_ACP2E-4601 - [contribution du code GitHub](https://github.com/magento/magento2/commit/c12a7510)_
...
#### `[CLOUD][B2B]` `[Mainline]` goulet d&#39;étranglement sales_clean_quotes getSize()

Améliorez les performances de la tâche cron sales_clean_quotes.

_ACP2E-4610 - [contribution du code GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_

#### Les sous-catégories de dernier niveau affichent zéro nombre de produits dans l’arborescence des catégories d’administration

Avant la correction, les catégories feuille n’incorporaient pas le nombre de produits lorsqu’elles étaient affichées dans l’arborescence des catégories de la zone d’administration. Après la correction, le nombre de produits est correctement affiché pour chaque feuille de catégorie.

_ACP2E-4689 - [contribution du code GitHub](https://github.com/magento/magento2/commit/d8a248cd)_

#### Performances des requêtes lentes sur la table magento_reward_history en raison de ses données volumineuses

Correction du problème en raison duquel la tâche cron d’expiration des points de récompense s’effectuait lentement sur les grandes tables magento_reward_history. Auparavant, la requête utilisée par l’expiration des points planifiés ne comportait pas d’index de base de données composites, ce qui entraînait des analyses complètes des tables contenant des millions d’enregistrements.
...
#### Le classement ou le filtrage par prix ne fonctionne pas pour les produits groupés en rupture de stock.

Lorsque l’option « Afficher les produits en rupture de stock » est activée, la page de liste des produits filtre désormais correctement et trie les produits en rupture de stock par prix.

_ACP2E-4475 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/f2fd9628) - [Contribution du code GitHub](https://github.com/magento/inventory/commit/a33c60f2)_
...
#### Caractères d’échappement inutiles dans l’interface du produit

Le système renvoie désormais des `>` sans échappement dans le nom de la réponse GraphQL.

_AC-15494 - [Problème GitHub](https://github.com/magento/magento2/issues/40178) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40423)_
...
#### Remboursement avec quantité négative toujours remboursement escompte
...
#### L’incohérence de l’ordre de tri des segments client entraîne la régénération continue du cookie X-Magento-Vary sur certaines pages
...
#### L’indexeur incrémentiel de la règle cible ne sélectionne pas les produits désactivés

L’indexation incrémentielle des règles de Target répond désormais lorsqu’un produit est activé ou désactivé, ce qui garantit que les recommandations liées/de vente incitative/de vente croisée sont mises à jour sans réindexation complète.

_ACP2E-4402_

#### La segmentation de la clientèle ne fonctionne pas correctement avec l’API REST

Les segments de clients basés sur le nombre de commandes sont désormais correctement mis à jour lorsque des commandes sont passées via l’API REST. Auparavant, l’appartenance à un segment n’était pas mise à jour pour les commandes d’API, car l’observateur dépendait de la session client, qui n’est pas disponible dans les requêtes d’API.

_ACP2E-4590_

#### Impossible de créer une règle de prix de panier avec la condition d’action « Catégorie (enfants uniquement) » via l’API REST

Correction du problème où la portée de l’attribut de condition de règle de prix du panier, telle que Catégorie (parent uniquement) et Catégorie (enfants uniquement), n’était pas exposée lorsque les règles étaient récupérées ou mises à jour via l’API REST.

_ACP2E-4653 - [contribution du code GitHub](https://github.com/magento/magento2/commit/d8a248cd)_

#### Les règles de prix de panier pour la livraison gratuite ne fonctionnent pas comme prévu pour les produits groupés

Amélioration de la gestion de la livraison gratuite

_ACP2E-4720 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/c58a8ad0)_

### Renvoie

#### Problème de sélection d’options simples lors du renvoi de produits groupés

Auparavant, avant l’implémentation de ce correctif, pour les produits groupés avec la possibilité d’envoyer les articles séparément pour les retours, la fonction « Sélectionner des articles » ouvrait uniquement le bloc pop-up pour la première fois. Après avoir sélectionné ou fermé le bloc pop-up, il ne l’ouvrait pas chaque fois que la fonction « Sélectionner des éléments » était appelée. Cependant, après l’application de ce correctif, le problème a été résolu et la fonctionnalité fonctionne désormais comme prévu.
...
#### Le message d’erreur n’est pas rendu pour la requête GET.

Correction d’un problème où les messages d’erreur ne s’affichaient pas immédiatement pour les requêtes GET non valides. Les messages d’erreur s’affichent désormais correctement sans nécessiter d’actions supplémentaires de la part des utilisateurs, ce qui améliore leurs retours et leur cohérence.

_AC-16296 - [Problème GitHub](https://github.com/magento/magento2/issues/40411) - [Contribution du code GitHub](https://github.com/magento/magento2/commit/8391dbcc)_

#### Caractères manquants dans la translittération

Le système gère désormais correctement la translittération des caractères manquants

_AC-16626 - [Problème GitHub](https://github.com/magento/magento2/issues/40580) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40581)_
...
#### AC-15210 ne semble pas complet. API REST USPS requise en moins d&#39;un mois.

L’intégration de l’API REST USPS dans Adobe Commerce (AC-15210) était incomplète. Les principaux problèmes étaient les suivants : informations de suivi manquantes, perte des paramètres des méthodes autorisées lors du changement de type d’API, requêtes excessives risquant d’entraîner des limites de quota et manque de protection contre les erreurs de limite de quota « 429 ». Le dépassement du quota a empêché l’affichage des tarifs d’expédition aux clients.
L’intégration de l’API REST USPS a été améliorée afin de :
- Fournir des informations de suivi appropriées pour les colis expédiés.
- Conservez les paramètres des méthodes autorisées lors du basculement entre les outils WEB USPS et les API REST.
- Empêchez les requêtes inutiles à l&#39;API USPS, ce qui réduit le risque d&#39;atteindre les limites de quota.
- Gérez les erreurs de limite de quota « 429 » de manière appropriée, en veillant à ce que les frais d’expédition restent disponibles pour les clients.

_AC-16577 - [Problème GitHub](https://github.com/magento/magento2/issues/40394) - [Contribution du code GitHub](https://github.com/magento/magento2/commit/15a9362d)_
...
#### La méthode d’expédition de l’API REST USPS ne s’affiche pas lors du passage en caisse pour certains produits

Les méthodes d’expédition de l’API REST USPS sont désormais disponibles pour les produits en caisse.

_ACP2E-4556 - [contribution du code GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
Correction d’un problème en raison duquel les modifications apportées aux règles de prix de catalogue via les mises à jour d’évaluation n’étaient pas répercutées de manière cohérente dans le panier. Après ce correctif, lorsqu’une mise à jour de règle de prix planifiée est appliquée, les prix des produits dans toutes les sections du panier (bloc central et bloc de synthèse) sont correctement mis à jour.

_AC-16530 - [Contribution du code GitHub](https://github.com/magento/magento2/commit/57bad413)_
...
#### Problème lié à la planification des prix spéciaux

Avant la correction, le prix spécial à partir de la date n’était pas correctement enregistré chaque fois qu’une mise à jour d’évaluation était enregistrée. Désormais, après la correction, les dates de début et de fin du prix spécial correspondant sont corrélées aux dates de début et de fin de la mise à jour d’évaluation.

_ACP2E-4433 - [contribution du code GitHub](https://github.com/magento/magento2/commit/f2fd9628)_
...
La conversion du prix dynamique du produit groupé hors calcul de la taxe pour l&#39;article du devis fonctionne correctement.

_ACP2E-4411 - [contribution du code GitHub](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [Problème ] SwiftOtter-SOP-348 Activer le cache de configuration compilé pour l’exécution du test

Améliore les performances du test d’intégration en activant le cache compilé_config pendant l’exécution du test, ce qui réduit l’utilisation de CPU et le temps d’exécution.

_AC-16018 - [Problème GitHub](https://github.com/magento/magento2/issues/40253) - [Contribution du code GitHub](https://github.com/magento/magento2/pull/40239)_
