...
---
# Packages de Magento Open Source
...
La documentation de référence suivante est générée à partir du `composer.lock` et couvre les packages requis inclus dans Magento Open Source 2.4.7.

## Dépendances

`magento/product-community-edition 2.4.7` a les dépendances suivantes :
