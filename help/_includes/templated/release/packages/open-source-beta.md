...
La documentation de référence suivante est générée à partir de la `composer.lock` et couvre les modules requis inclus dans Magento Open Source 2.4.7-beta3.

## Dépendances

`magento/product-community-edition 2.4.7-beta3` comporte les dépendances suivantes :
