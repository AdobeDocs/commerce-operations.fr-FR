...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Configuration et sécurité du réseau interne</td>
            <td></td>
            <td></td>
            <td>Propriétaire</td>
        </tr>
        <tr>
            <td>Approvisionnement des applications Adobe Commerce</td>
            <td></td>
            <td></td>
            <td>Propriétaire</td>
        </tr>
        ...
        <tr>
            <td>Approvisionnement du service CDN</td>
            <td></td>
            <td></td>
            <td>Propriétaire</td>
        </tr>
        <tr>
            <td>Environnement de développement local</td>
            <td>Contributeur</td>
            <td>Propriétaire</td>
            <td></td>
        </tr>
        <tr>
            <td colspan="4" style="background:lightgray;"><strong>Développement et assurance qualité</strong></td>
        </tr>
        <tr>
            <td>Collecte des exigences et gestion de projet</td>
            <td>Contributeur</td>
            <td>Propriétaire</td>
            <td>Conseiller</td>
        </tr>
        <tr>
            <td>Développement d’applications</td>
            <td>Contributeur</td>
            <td>Propriétaire</td>
            <td>Conseiller</td>
        </tr>
        ...
        <tr>
            <td>Exigences de surveillance personnalisées</td>
            <td>Contributeur</td>
            <td>Propriétaire</td>
            <td>Conseiller</td>
        </tr>
        <tr>
            <td>Certificats SSL fournis par le client</td>
            <td>Propriétaire</td>
            <td></td>
            <td>Contributeur</td>
        </tr>
        ...
        <tr>
            <td>Déploiement du code de production</td>
            <td>Contributeur</td>
            <td>Contributeur</td>
            <td>Propriétaire</td>
        </tr>
        ...
        <tr>
            <td>Surveillance des applications principales</td>
            <td>Contributeur</td>
            <td>Contributeur</td>
            <td>Propriétaire</td>
        </tr>
        ...
        <tr>
            <td>Administration des applications de production</td>
            <td>Propriétaire</td>
            <td>Contributeur</td>
            <td>Conseiller</td>
        </tr>
        ...
        <tr>
            <td>Certification PCI de l’infrastructure</td>
            <td></td>
            <td></td>
            <td>Propriétaire</td>
        </tr>
        <tr>
            <td>Certification PCI de l’application personnalisée</td>
            <td>Propriétaire</td>
            <td>Contributeur</td>
            <td></td>
        </tr>
        <tr>
            <td>Audits de sécurité des applications principales</td>
            <td>Propriétaire</td>
            <td>Contributeur</td>
            <td>Conseiller</td>
        </tr>
        ...
        <tr>
            <td>Surveillance de la détection des intrusions</td>
            <td></td>
            <td></td>
            <td>Propriétaire</td>
        </tr>
...
<thead>
  <tr>
    ...
    <th>Tâche</th>
    <th>Client</th>
    <th>Partenaire de développement*</th>
