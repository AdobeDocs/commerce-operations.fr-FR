...
| [Vérifier la configuration de la sécurité](https://experienceleague.adobe.com/fr/docs/commerce-on-cloud/user-guide/launch/checklist) | Consultez les éléments de la liste de contrôle avant de lancer un site d’infrastructure cloud Adobe Commerce. |
