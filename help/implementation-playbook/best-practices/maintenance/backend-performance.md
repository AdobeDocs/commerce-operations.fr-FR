...
- [Augmentation de la capacité de pointe](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/holiday-surge-capacity-requests-for-magento-commerce-cloud)
...
- [Conseils de test](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/develop/test/guidance) (infrastructure cloud)
...
- [Surveillance des performances](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/monitor/performance) (infrastructure cloud)
...
- [Configuration de l’application - propriété crons](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure/app/properties/crons-property) (infrastructure cloud)
- [Configuration et exécution de crons](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure/app/properties/crons-property) (sur site)
