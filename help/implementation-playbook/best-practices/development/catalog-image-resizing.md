...
La sortie renvoie une liste de toutes les images de produit du magasin. Vous pouvez explorer aux images (avec `siege` ou tout autre robot d&#39;exploration) à l’aide de tous les serveurs et cœurs de processeur à votre disposition et générer le cache de redimensionnement à une vitesse beaucoup plus rapide que les autres approches.
