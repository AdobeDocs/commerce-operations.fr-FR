...
Voir ce [tutoriel vidéo](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/upgrade/upgrade-compatibility-tool-overview.html) (06:02) pour en savoir plus sur le [!DNL Upgrade Compatibility Tool].
