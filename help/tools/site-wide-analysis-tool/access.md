...
>[!NOTE]
>
>Pour accéder à l’outil d’analyse à l’échelle du site (SWAT), les utilisateurs doivent disposer des autorisations requises dans Adobe Commerce Admin. L’accès direct à l’URL SWAT, y compris les liens marqués d’un signet, n’est pas pris en charge.
