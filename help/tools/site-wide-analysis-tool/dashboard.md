...
* Les [!DNL widgets] [!UICONTROL Recommendations] et [!UICONTROL Extensions] ont accès à la page complète de données de chaque fonctionnalité en cliquant sur **[!UICONTROL View All]**.
