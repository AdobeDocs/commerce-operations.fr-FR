...
* Si votre site ne répond plus ou ne répond plus du tout, mettez-le immédiatement en mode de maintenance. Pour connaître les étapes, reportez-vous à la section [Activation ou désactivation du mode de maintenance](/help/installation/tutorials/maintenance-mode.md) dans le Guide d’installation de Commerce.
