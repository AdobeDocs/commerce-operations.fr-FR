...
Le correctif ACSD-47988 corrige le problème en raison duquel l’exportation du produit efface les balises HTML de la description du produit page builder. Ce correctif est disponible lorsque la version 1.1.26 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-47988. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
