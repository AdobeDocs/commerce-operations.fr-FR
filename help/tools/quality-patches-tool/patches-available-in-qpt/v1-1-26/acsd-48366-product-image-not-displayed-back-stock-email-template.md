...
Le correctif ACSD-48366 corrige le problème en raison duquel l’image miniature du produit n’est pas affichée dans l’e-mail d’alerte de stock du produit. Ce correctif est disponible lorsque la version 1.1.26 de [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/fr/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) est installée. L’ID du correctif est ACSD-48366. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
