...
Le correctif ACSD-48587 corrige le problème en raison duquel les caractères spéciaux HTML dans les règles de correspondance du widget de produits les empêchent d’afficher les produits correspondants. Ce correctif est disponible lorsque la version 1.1.26 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-48587. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
...
1. Vérifiez le contenu *Page* pour l’aperçu *Page Builder* et le storefront du produit.
