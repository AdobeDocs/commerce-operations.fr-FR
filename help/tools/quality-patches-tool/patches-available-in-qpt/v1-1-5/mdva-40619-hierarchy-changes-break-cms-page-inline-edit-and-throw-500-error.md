...
Le correctif MDVA-40619 résout le problème où les modifications de la hiérarchie de page CMS rompent la modification de la page CMS en ligne et génèrent une « erreur 500 ». Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.5 est installé. L’ID du correctif est MDVA-40619. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.4.
