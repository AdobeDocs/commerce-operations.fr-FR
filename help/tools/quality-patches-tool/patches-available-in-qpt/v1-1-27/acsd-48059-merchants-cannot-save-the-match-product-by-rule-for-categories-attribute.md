...
Le correctif ACSD-48059 corrige le problème en raison duquel les commerçants ne peuvent pas enregistrer les *[!UICONTROL Match product by rule]* de l’attribut categories dans [!DNL Visual Merchandiser]. Ce correctif est disponible lorsque la version 1.1.27 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-48059. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
