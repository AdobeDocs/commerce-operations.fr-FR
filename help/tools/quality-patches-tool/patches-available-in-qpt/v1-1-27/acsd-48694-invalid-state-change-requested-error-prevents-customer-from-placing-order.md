...
Le correctif ACSD-48694 corrige le problème où l’erreur *modification d’état non valide demandée* empêche un client de passer une commande. Ce correctif est disponible lorsque la version 1.1.27 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-48694. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
