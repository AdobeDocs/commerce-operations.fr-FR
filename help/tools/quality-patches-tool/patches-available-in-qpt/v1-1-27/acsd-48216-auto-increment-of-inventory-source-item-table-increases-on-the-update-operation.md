...
Le correctif ACSD-48216 corrige le problème où *AUTO_INCREMENT* de la table *inventory_source_item* augmente lors de l’opération *UPDATE*. Ce correctif est disponible lorsque la version 1.1.27 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-48216. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
