...
Le correctif ACSD-56842 corrige le problème en raison duquel les proxies différés et les fabriques de proxy sont manquants après l’exécution de `setup:di:compile`. Ce correctif est disponible lorsque la version 1.1.46 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-56842. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
