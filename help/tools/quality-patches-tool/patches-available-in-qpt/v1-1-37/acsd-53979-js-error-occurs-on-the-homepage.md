...
Le correctif ACSD-53979 corrige le problème où une erreur JavaScript se produit sur la page d’accueil si le message de bienvenue contient une apostrophe. Ce correctif est disponible lorsque la version 1.1.37 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-53979. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
