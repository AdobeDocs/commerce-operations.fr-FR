...
Le correctif ACSD-53148 corrige le problème en raison duquel deux demandes parallèles dans GraphQL pour l’ajout d’un même produit configurable au panier entraînaient deux articles distincts dans le panier avec le même SKU de produit. Ce correctif est disponible lorsque la version 1.1.37 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-53148. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
