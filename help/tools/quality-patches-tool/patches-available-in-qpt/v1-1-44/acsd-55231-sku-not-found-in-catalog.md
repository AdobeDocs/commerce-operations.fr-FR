...
Le correctif ACSD-55231 corrige le problème en raison duquel le SKU n’a pas été trouvé dans l’erreur *catalogue* lors de l’ajout d’un produit au panier à l’aide de la fonctionnalité de commande rapide. Ce correctif est disponible lorsque la version 1.1.44 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-55231. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
