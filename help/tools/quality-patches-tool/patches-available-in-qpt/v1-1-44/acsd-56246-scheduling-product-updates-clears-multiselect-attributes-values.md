...
Le correctif ACSD-56246 corrige le problème où la planification des mises à jour de produits efface les valeurs d’attributs à sélection multiple. Ce correctif est disponible lorsque la version 1.1.44 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-56246. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
