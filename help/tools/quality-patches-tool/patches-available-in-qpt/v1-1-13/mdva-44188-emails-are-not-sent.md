...
Le correctif MDVA-44188 corrige le problème où les e-mails ne sont pas envoyés aux ID de messagerie contenant les `.-`. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.13 est installé. L’ID du correctif est MDVA-44188. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
