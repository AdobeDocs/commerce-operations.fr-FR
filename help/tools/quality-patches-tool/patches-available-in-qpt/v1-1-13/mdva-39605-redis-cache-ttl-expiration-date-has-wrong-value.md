...
Le correctif MDVA-39605 résout le problème lorsque la TTL du cache Redis (date d’expiration) a une valeur incorrecte. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.13 est installé. L’ID du correctif est MDVA-39605. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
