...
Le correctif ACSD-55238 corrige le problème où une description de produit contenant du code HTML généré par un éditeur HTML est toujours affichée dans la méta-description. Ce correctif est disponible lorsque la version 1.1.42 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-55238. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
