...
Le correctif ACSD-53658 corrige le problème où les données **[!UICONTROL Recently Viewed Product]** ne sont pas correctement mises à jour dans la vue du magasin. Ce correctif est disponible lorsque la version 1.1.42 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-53658. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
