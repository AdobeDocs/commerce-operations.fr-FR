...
Le correctif MDVA-39043 corrige le problème en raison duquel les utilisateurs administrateurs à accès limité reçoivent une erreur lors de l’ajout du widget « Produits » à la page CMS. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.2 est installé. L’ID du correctif est MDVA-39043. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.4.
