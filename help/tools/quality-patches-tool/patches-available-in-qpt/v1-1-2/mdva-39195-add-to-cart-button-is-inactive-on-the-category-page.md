...
Le correctif MDVA-39195 résout le problème où le bouton **Ajouter au panier** est inactif sur la page Catégorie lorsque la redirection vers le panier est activée. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.2 est installé. L’ID du correctif est MDVA-39195. Notez que le problème a été résolu dans Adobe Commerce 2.4.3.
