...
Le correctif ACSD-47292 corrige le problème où les produits en rupture de stock groupés ne sont pas disponibles dans la réponse GraphQL même si le [!UICONTROL Display Out-of-Stock Products] est défini sur *[!UICONTROL Yes]*. Ce correctif est disponible lorsque la version 1.1.25 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-47292. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.6.
