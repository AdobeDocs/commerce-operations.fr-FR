...
Le correctif B2B-2598 ajoute une fonctionnalité de mise en cache aux requêtes GraphQl `storeConfig`, `currency`, `country`, `countries` et `availableStores`. Ce correctif est disponible lorsque la version 1.1.30 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est B2B-2598. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7-beta1.
