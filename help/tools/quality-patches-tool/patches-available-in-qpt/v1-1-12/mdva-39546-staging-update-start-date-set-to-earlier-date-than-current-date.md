...
Le correctif MDVA-39546 corrige le problème en raison duquel la date de début de la mise à jour d’évaluation peut être définie à une date antérieure à la date actuelle. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.12 est installé. L’ID du correctif est MDVA-39546. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
