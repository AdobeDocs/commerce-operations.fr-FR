...
Le correctif MDVA-41628 corrige le problème en raison duquel les utilisateurs administrateurs restreints peuvent accéder aux nouvelles ressources lorsque de nouveaux modules sont ajoutés. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.12 est installé. L’ID du correctif est MDVA-41628. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
