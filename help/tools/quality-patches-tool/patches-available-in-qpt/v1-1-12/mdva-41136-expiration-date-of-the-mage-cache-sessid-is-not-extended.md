...
Le correctif MDVA-41136 résout le problème où la date d’expiration du cookie `mage-cache-sessid` n’est pas prolongée, ce qui entraîne le nettoyage des données client. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.12 est installé. L’ID du correctif est MDVA-41136. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
