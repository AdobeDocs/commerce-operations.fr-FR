...
1. Connectez-vous en tant que client et ajoutez un produit à [[!UICONTROL Requisition List]](https://experienceleague.adobe.com/fr/docs/commerce-admin/b2b/requisition-lists/requisition-lists).
