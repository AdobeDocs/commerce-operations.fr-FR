...
Le correctif MDVA-44147 corrige le problème en raison duquel [!DNL GraphQL] requête ne renvoie pas de [!UICONTROL Requisition Lists]. Ce correctif est disponible lorsque la version 1.1.14 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est MDVA-44147. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
