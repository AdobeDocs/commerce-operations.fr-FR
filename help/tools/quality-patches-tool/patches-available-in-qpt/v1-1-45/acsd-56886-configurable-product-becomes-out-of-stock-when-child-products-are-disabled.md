...
Le correctif ACSD-56886 corrige le problème où le produit configurable devient en rupture de stock lorsque les produits enfants sont désactivés. Ce correctif est disponible lorsque la version 1.1.45 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-56886. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
