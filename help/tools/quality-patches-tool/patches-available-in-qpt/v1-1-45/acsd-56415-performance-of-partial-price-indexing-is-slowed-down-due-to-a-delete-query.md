...
Le correctif ACSD-56415 corrige le problème où les performances de la [!UICONTROL Partial Price Indexing] sont ralenties en raison d&#39;une requête `DELETE` lorsque la base de données a beaucoup d&#39;index de données de prix partiels. Ce correctif est disponible lorsque la version 1.1.45 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-56023. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
