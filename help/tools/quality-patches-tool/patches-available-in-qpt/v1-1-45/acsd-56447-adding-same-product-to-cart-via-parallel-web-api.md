...
Le correctif ACSD-56447 corrige le problème en raison duquel l’ajout d’un même produit au panier via des requêtes d’API Web REST parallèles génère deux éléments distincts dans le panier. Ce correctif est disponible lorsque la version 1.1.45 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-56447. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
