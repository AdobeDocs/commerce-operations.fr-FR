...
Le correctif ACSD-49370 corrige le problème en raison duquel l’attribut de produit possède un type `FilterMatchTypeInput` dans le schéma GraphQL. Ce correctif est disponible lorsque la version 1.1.28 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-49370. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
