...
Le correctif ACSD-48807 corrige le problème en raison duquel les avis sur les produits ne sont pas filtrés par storeview via GraphQL. Ce correctif est disponible lorsque la version 1.1.28 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-48807. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
