...
Le correctif ACSD-49433 corrige le problème où le montant par défaut est affiché comme sous-total dans le panier pour la carte cadeau avec un montant ouvert. Ce correctif est disponible lorsque la version 1.1.28 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-49433. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
...
1. Indiquez un montant de 100 $ dans USD.
