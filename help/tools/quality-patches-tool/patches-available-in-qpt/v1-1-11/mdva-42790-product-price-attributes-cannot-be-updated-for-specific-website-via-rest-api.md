...
Le correctif MDVA-42790 corrige le problème en raison duquel les utilisateurs ne sont pas en mesure de mettre à jour les attributs de prix de produit pour des sites web spécifiques via l’API REST. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.11 est installé. L’ID du correctif est MDVA-42790. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
