...
Le correctif MDVA-42237 corrige le problème en raison duquel le prix spécial du produit configurable n&#39;est pas mis à jour après les modifications apportées au prix du sous-produit. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.11 est installé. L’ID du correctif est MDVA-42237. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
