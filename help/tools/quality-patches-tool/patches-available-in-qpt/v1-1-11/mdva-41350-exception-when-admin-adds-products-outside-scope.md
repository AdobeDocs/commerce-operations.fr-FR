...
Le correctif MDVA-41350 corrige le problème où une erreur d’exception est déclenchée au lieu d’une notification d’accès limité lorsqu’un utilisateur administrateur ajoute un produit dans la commande par SKU qui n’est pas accessible. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.11 est installé. L’ID du correctif est MDVA-41350. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
