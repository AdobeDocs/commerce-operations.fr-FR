...
Le correctif ACSD-47107 corrige le problème d’application de la règle de prix de catalogue aux options personnalisées. Ce correctif est disponible lorsque la version 1.1.23 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-47107. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.6.
