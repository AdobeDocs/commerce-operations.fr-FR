...
Le correctif ACSD-46519 résout le problème où la [!UICONTROL product_count] dans [!UICONTROL categoryList] requête [!DNL GraphQL] renvoie 0 pour les catégories d’ancrage. Ce correctif est disponible lorsque la version 1.1.23 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-46519. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.6.
