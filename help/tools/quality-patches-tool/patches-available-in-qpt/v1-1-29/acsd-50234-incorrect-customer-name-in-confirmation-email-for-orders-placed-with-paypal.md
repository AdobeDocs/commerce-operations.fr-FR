...
Le correctif ACSD-50234 corrige le problème d’affichage incorrect du nom du client dans l’e-mail de confirmation pour les commandes passées à l’aide de [!DNL PayPal]. Ce correctif est disponible lorsque la version 1.1.29 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-50234. Notez que le problème a été résolu dans Adobe Commerce 2.4.5.
