...
Le correctif ACSD-49773 corrige le problème d’échec de l’exportation du produit lorsque AWS S3 est utilisé comme stockage distant. Ce correctif est disponible lorsque la version 1.1.29 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-49773. Notez que le problème a été résolu dans Adobe Commerce 2.4.6.
