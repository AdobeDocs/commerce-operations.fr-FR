...
Le correctif MDVA-44660 corrige le problème en raison duquel le caractère d’accentuation grave (\`) ne peut pas être utilisé pour le nom d’un client. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.15 est installé. L’ID du correctif est MDVA-44660. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
