...
Le correctif ASCD-55334 corrige le problème où les libellés ne sont pas traduits par le biais de dictionnaires de traduction dans la réponse de GraphQL. Ce correctif est disponible lorsque la version 1.1.43 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ASCD-55334. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
