...
Le correctif ACSD-60326 corrige le problème où une erreur se produit dans la requête GraphQL pour le statut de [!UICONTROL Returns] du client. Ce correctif est disponible lorsque la version 1.1.51 de [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/fr/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) est installée. L’ID du correctif est ACSD-60326. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.8.
