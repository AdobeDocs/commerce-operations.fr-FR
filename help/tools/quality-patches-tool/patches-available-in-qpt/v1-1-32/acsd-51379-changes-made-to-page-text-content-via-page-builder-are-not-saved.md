...
Le correctif ACSD-51379 corrige le problème où les modifications apportées au contenu textuel d’une page via [!DNL Page Builder] ne sont pas enregistrées. Ce correctif est disponible lorsque la version 1.1.32 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-51379. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
