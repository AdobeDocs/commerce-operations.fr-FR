...
Le correctif ACSD-61322 corrige le problème où les produits/catégories non affectés au [!UICONTROL Shared Catalog] pour le groupe par défaut (Général) sont toujours inclus dans le plan de site XML. Ce correctif est disponible lorsque la version 1.1.52 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-61322. Notez que ce problème doit être résolu dans Adobe Commerce 2.4.8.
