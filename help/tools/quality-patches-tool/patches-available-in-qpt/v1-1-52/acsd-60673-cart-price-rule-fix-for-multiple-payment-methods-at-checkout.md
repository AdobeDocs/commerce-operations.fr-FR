...
Le correctif ACSD-60673 corrige le problème où les escomptes d&#39;un [!UICONTROL Cart Price Rule] qui utilise une condition de mode de paiement ne sont pas toujours répertoriés dans les totaux. Ce correctif est disponible lorsque la version 1.1.52 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-60673. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.8.
