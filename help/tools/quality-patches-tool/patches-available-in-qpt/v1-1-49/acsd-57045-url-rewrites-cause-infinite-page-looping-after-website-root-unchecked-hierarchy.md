...
Le correctif ACSD-57045 corrige le problème où les réécritures d’URL provoquent un bouclage de page infini après que **[!UICONTROL Website Root]** n’est plus coché dans **[!UICONTROL Hierarchy]**. Ce correctif est disponible lorsque la version 1.1.49 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-57045. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.5.0.
