...
Le correctif ACSD-57846 corrige le problème où le filtrage des produits pour un prix nul entraîne une demande incorrecte à [!DNL OpenSearch] et ne renvoie aucun résultat. Ce correctif est disponible lorsque la version 1.1.49 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-57846. Notez que le problème a été résolu dans Adobe Commerce 2.4.7.
