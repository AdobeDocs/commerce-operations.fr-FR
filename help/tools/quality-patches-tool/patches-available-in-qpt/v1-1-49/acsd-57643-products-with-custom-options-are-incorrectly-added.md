...
Le correctif ACSD-57643 corrige le problème où les produits avec des options personnalisées sont incorrectement ajoutés au panier via GraphQL. Ce correctif est disponible lorsque la version 1.1.49 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-57643. Notez que le problème a été résolu dans Adobe Commerce 2.4.7.
