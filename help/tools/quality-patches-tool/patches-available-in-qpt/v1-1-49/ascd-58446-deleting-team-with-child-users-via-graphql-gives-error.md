...
Le correctif ACSD-58446 corrige le problème d’Adobe Commerce en raison duquel la suppression d’une équipe avec des utilisateurs ou des équipes enfants via GraphQL renvoie un message d’erreur informatif incompatible avec l’interface utilisateur. Ce correctif est disponible lorsque la version 1.1.49 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-58446. Notez que le problème est planifié pour être corrigé dans Adobe Commerce B2B 1.5.1
