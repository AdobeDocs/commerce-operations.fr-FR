...
Le correctif ACSD-56979 corrige le problème de suppression des images de produits après la suppression d’une mise à jour d’évaluation. Ce correctif est disponible lorsque la version 1.1.49 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-56979. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.5.0.
