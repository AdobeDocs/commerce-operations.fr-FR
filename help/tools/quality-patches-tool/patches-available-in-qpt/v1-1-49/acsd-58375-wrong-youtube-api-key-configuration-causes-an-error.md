...
Le correctif ACSD-58735 corrige le problème en raison duquel une configuration incorrecte de la clé API YouTube provoque une erreur lors de l’ajout d’une vidéo YouTube au niveau de la vue du magasin. Ce correctif est disponible lorsque la version 1.1.49 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-58735. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.8.
