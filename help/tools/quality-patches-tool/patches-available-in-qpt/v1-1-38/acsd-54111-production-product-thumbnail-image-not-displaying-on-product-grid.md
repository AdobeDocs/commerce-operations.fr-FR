...
Le correctif ACSD-54111 corrige le problème où toutes les images sont remplacées par l’image d’espace réservé de produit par défaut. Ce correctif est disponible lorsque la version 1.1.38 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-54111. Notez que le problème a été résolu dans Adobe Commerce 2.4.6.
