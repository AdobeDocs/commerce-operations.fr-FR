...
Le correctif ACSD-53824 corrige le problème en raison duquel le déploiement échoue lors de la mise à niveau de l’installation. Ce correctif est disponible lorsque la version 1.1.38 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-53824. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
