...
Le correctif ACSD-54776 corrige le problème en raison duquel les valeurs de champ de produit non cochées **[!UICONTROL Use Default Value]** et non par défaut ne sont pas enregistrées pour la deuxième vue de site web, de magasin et de magasin. Ce correctif est disponible lorsque la version 1.1.39 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-54776. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
