...
Le correctif ACSD-53704 corrige le problème où l’historique du solde des points de récompense est mal calculé après la date d’expiration des points de récompense. Ce correctif est disponible lorsque la version 1.1.39 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-53704. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.7.
