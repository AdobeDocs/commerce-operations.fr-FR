...
Le correctif MDVA-38666 résout le problème en raison duquel l’utilisateur administrateur ne peut pas modifier les options de produit configurables dans le panier du client. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.9 est installé. L’ID du correctif est MDVA-38666. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
