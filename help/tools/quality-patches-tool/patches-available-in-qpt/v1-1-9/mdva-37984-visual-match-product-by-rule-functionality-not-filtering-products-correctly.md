...
Le correctif MDVA-37984 résout le problème en raison duquel la fonctionnalité « Faire correspondre le produit par règle » de Visual Merchandiser ne filtre pas correctement les produits lors de l’application des mises à jour d’évaluation. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.9 est installé. L’ID du correctif est MDVA-37984. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
