...
Le correctif MDVA-40550 résout le problème où la réindexation entraîne la perte de certains produits ou de tous les produits des catégories de storefront. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.6 est installé. L’ID du correctif est MDVA-40550. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.4.
