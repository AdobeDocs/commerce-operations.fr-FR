...
Le correctif ACSD-45169 corrige le problème où Visual Merchandiser n’affiche pas le stock et le prix corrects d’un produit configurable après l’application d’une mise à jour d’évaluation. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.17 est installé. L’ID du correctif est ACSD-45169. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.6.
