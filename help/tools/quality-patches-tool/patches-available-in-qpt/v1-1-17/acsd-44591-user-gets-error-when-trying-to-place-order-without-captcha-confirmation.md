...
Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.17 est installé. L’ID du correctif est ACSD-44591. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.6.
