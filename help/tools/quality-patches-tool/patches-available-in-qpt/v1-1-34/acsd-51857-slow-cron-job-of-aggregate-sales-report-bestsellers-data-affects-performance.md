...
Le correctif ACSD-51857 corrige le problème où les tâches cron lentes `aggregate_sales_report_bestsellers_data` affectent les tables de base de données `sales_order` et `sales_order_item` volumineuses. Ce correctif est disponible lorsque la version 1.1.34 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-51857. Notez que le problème a été résolu dans Adobe Commerce 2.4.7.
