...
Le correctif ACSD-58790 corrige le problème d’Adobe Commerce en raison duquel l’image en mode mobile sur [!DNL Chrome] n’a pas effectué le zoom avant prévu sur l’image. Ce correctif est disponible lorsque la version 1.1.50 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-58790. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.8.
