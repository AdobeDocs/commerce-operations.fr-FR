...
Le correctif ACSD-58442 corrige le problème d’Adobe Commerce où les appareils d’une largeur de 768 px sont traités comme des appareils mobiles, ce qui entraîne le chargement du menu et de l’en-tête dans une vue mobile au lieu d’un bureau. Ce correctif est disponible lorsque la version 1.1.50 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-58442. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.8.
