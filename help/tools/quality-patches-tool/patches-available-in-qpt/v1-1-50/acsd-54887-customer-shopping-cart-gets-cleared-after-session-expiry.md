...
Le correctif ACSD-54887 corrige le problème d’effacement du panier du client après l’expiration de la session client avec le [!UICONTROL Persistent Shopping Cart] activé. Ce correctif est disponible lorsque la version 1.1.50 de [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) est installée. L’ID du correctif est ACSD-54887. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.8.
