...
Le correctif MDVA-41305 résout le problème où les utilisateurs et utilisatrices obtiennent une erreur lors de l’`addProductsToWishlist` de requêtes GraphQL pour les produits configurables. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.10 est installé. L’ID du correctif est MDVA-41305. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
