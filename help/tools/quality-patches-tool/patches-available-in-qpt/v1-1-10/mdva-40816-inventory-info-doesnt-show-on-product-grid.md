...
# MDVA-40816 : données d’inventaire non affichées sur la grille de produits

Le correctif MDVA-40816 résout le problème où les informations d’inventaire ne s’affichent pas sur la grille de produits si un SKU de produit contient des caractères spéciaux. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.10 est installé. L’ID du correctif est MDVA-40816. Notez que le problème est planifié pour être corrigé dans Adobe Commerce 2.4.5.
...
Les données d’inventaire ne s’affichent pas sur la grille de produits si un SKU de produit contient des symboles spéciaux.
...
1. Modifiez le SKU d’un produit pour inclure des symboles spéciaux tels que &amp; ou .
1. Ouvrez la grille de produits.

<u>Résultats attendus</u> :

La grille de produits affiche correctement toutes les informations.
